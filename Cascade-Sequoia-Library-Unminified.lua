...
--[[
    ...
    @buildDate "2026-06-20T17:23:48.475747Z"
    @buildCfg "Release"
    @buildVers "1.2.0"
...
local creator = __DIST.d()
	...
	local function drawWedge(containerFrame, startAngle, sweepAngle, color)
		...
		local function createHalfWedge(parentFrame, rotationAngle)
			...
			create("ImageLabel")({
				...
				Position = UDim2.fromScale(-1, 0),
				BackgroundTransparency = 1,
				Image = "rbxassetid://2009137452", -- public standard white circle
				ImageColor3 = color,
	...
	if properties.Donut then
		local donutCenter = create("ImageLabel")({
			Name = "DonutCenter",
...
local creator = __DIST.d()
	...
	local chartContainer = create("Frame")({
		Name = "LineChart",
		Size = hasTitle and UDim2.new(0.6, 0, 1, 0) or UDim2.new(1, 0, 0, properties.Height),
		BackgroundTransparency = 1,
		BorderSizePixel = 0,
		LayoutOrder = hasTitle and chartOrder or nil,
		Parent = getRaw(parent),
	})
	...
	local function drawChart()
		...
		for i = 1, n do
			...
			local dot = create("ImageButton")({
				...
				BackgroundTransparency = 1,
				Image = "rbxassetid://2009137452", -- public standard white circle
				ImageColor3 = resolvedColor,
				ZIndex = 5,
				Parent = getRaw(renderArea),

				create("UICorner")({
					CornerRadius = UDim.new(1, 0), -- Force round
				}),
			}) :: ImageButton
