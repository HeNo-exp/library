...
--[[
    ...
    @buildDate "2026-07-21T16:16:37.214959Z"
    @buildCfg "Task"
    @buildVers "0.0.0"
...
local creator = __DIST.d()
	...
	local function drawChart()
		...
		if isAnimated then
			...
			tweenService:Create(uiScale, TweenInfo.new(0.35, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {
				Scale = 1,
			}):Play()
