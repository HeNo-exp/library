...
--[[
    ...
    @buildDate "2026-06-21T00:53:37.413000Z"
    @buildCfg "Task"
    @buildVers "0.0.0"
		...
		Selected = function(selected: boolean)
			...
			if selected and tabAnim == "move" and window and window.Structures.TabMoveIndicator then
				...
				local function updatePos(instant)
					...
					if localY == lastY and localX == lastX then
						return
					end
					lastY, lastX = localY, localX

					local targetPos = UDim2.fromOffset(localX + 2, localY + tabBody.AbsoluteSize.Y / 2)
