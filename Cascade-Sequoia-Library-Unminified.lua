...
--[[
    ...
    @buildDate "2026-06-20T17:35:33.472976Z"
    @buildCfg "Release"
    @buildVers "1.2.0"
...
local creator = __DIST.d()
	...
	if hasTitle then
		...
		textOrder = (align == "Right") and 1 or 3
		chartOrder = (align == "Right") and 3 or 1
		...
		-- Create horizontal list layout in mainContainer
		create("UIListLayout")({
			FillDirection = Enum.FillDirection.Horizontal,
			VerticalAlignment = Enum.VerticalAlignment.Center,
			Padding = UDim.new(0, 16),
	...
	-- Main horizontal layout containing chart (left) and legends (right)
...
local creator = __DIST.d()
	...
	-- Left Y-axis labels container (reserved width: 35px)
	...
	-- Sub-container for visual rendering (shifted to the right by 35px)
