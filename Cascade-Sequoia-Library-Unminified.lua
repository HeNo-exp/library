...
--[[
    ...
    @buildDate "2026-06-20T17:11:17.944658Z"
    @buildCfg "Release"
    @buildVers "1.2.0"
...
local creator = __DIST.d()
	...
	legendStack.Structures.Body.Parent = structures.Body
	...
	for _, item in ipairs(properties.Data) do
		...
		local legendRow = create("Frame")({
			...
			BackgroundTransparency = 1,
			Parent = legendStack.Structures.Body,
