...
local binder = __DIST.c()
	...
	structures.Body.Parent = typeof(self) == "table" and (self.__container or self.__instance) or self
	structures.Body.AutomaticSize = Enum.AutomaticSize.XY
	...
	local window = nil
	if __SH and __SH.COMPINDEXES then
	...
	object.Theme = typeof(self) == "table" and self.Theme or nil
	object.Structures = structures
