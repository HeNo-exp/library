...
type App__DARKLUA_TYPE_r = AppProperties__DARKLUA_TYPE_q & Components__DARKLUA_TYPE_af
...
type ComponentContext__DARKLUA_TYPE_t = ComponentProperties__DARKLUA_TYPE_s & Components__DARKLUA_TYPE_af
...
type WindowProperties__DARKLUA_TYPE_w = Frame__DARKLUA_TYPE_g & {
	Searching: boolean?,
	Draggable: boolean?,
	Resizable: boolean?,
	Title: string?,
...
type Window__DARKLUA_TYPE_x = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_af & WindowProperties__DARKLUA_TYPE_w

type SectionProperties__DARKLUA_TYPE_y = Frame__DARKLUA_TYPE_g & {
	Title: string?,
	Disclosure: boolean?,
	Expanded: boolean?,
}

type Section__DARKLUA_TYPE_z = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_af & SectionProperties__DARKLUA_TYPE_y

type TabProperties__DARKLUA_TYPE_A = Frame__DARKLUA_TYPE_g & {
	Title: string?,
	Icon: string?,
	Indentation: number?,
	Selected: boolean?,
	Page: Page__DARKLUA_TYPE_N?,
}

type Tab__DARKLUA_TYPE_B = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_af & TabProperties__DARKLUA_TYPE_A & {
	Navigate: (self: Tab__DARKLUA_TYPE_B, page: Page__DARKLUA_TYPE_N) -> nil,
	Structures: { [string]: Instance__DARKLUA_TYPE_b | { any }, Page: Page__DARKLUA_TYPE_N},
}

type FormProperties__DARKLUA_TYPE_C = Frame__DARKLUA_TYPE_g

type Form__DARKLUA_TYPE_D = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_af & FormProperties__DARKLUA_TYPE_C

type RowProperties__DARKLUA_TYPE_E = Frame__DARKLUA_TYPE_g & {
	SearchIndex: string?,
}

type Row__DARKLUA_TYPE_F = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_af & RowProperties__DARKLUA_TYPE_E & {
	Left: (self: Row__DARKLUA_TYPE_F) -> Row__DARKLUA_TYPE_F,
	Right: (self: Row__DARKLUA_TYPE_F) -> Row__DARKLUA_TYPE_F,
}

type StackProperties__DARKLUA_TYPE_G = Frame__DARKLUA_TYPE_g & {
	Padding: UDim?,
	HorizontalAlignment: Enum.HorizontalAlignment?,
	VerticalAlignment: Enum.VerticalAlignment?,
}

type Stack__DARKLUA_TYPE_H = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_af & StackProperties__DARKLUA_TYPE_G

type TitleStackProperties__DARKLUA_TYPE_I = Frame__DARKLUA_TYPE_g & {
	Title: string?,
	Subtitle: string?,
}

type TitleStack__DARKLUA_TYPE_J = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_af & TitleStackProperties__DARKLUA_TYPE_I

type PageSectionProperties__DARKLUA_TYPE_K = Frame__DARKLUA_TYPE_g & {
	Title: string?,
	Subtitle: string?,
}

type PageSection__DARKLUA_TYPE_L = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_af & PageSectionProperties__DARKLUA_TYPE_K

type PageProperties__DARKLUA_TYPE_M = ScrollingFrame

type Page__DARKLUA_TYPE_N = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_af & PageProperties__DARKLUA_TYPE_M

type LabelProperties__DARKLUA_TYPE_O = TextLabel__DARKLUA_TYPE_h

type Label__DARKLUA_TYPE_P = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_af & LabelProperties__DARKLUA_TYPE_O

type SymbolProperties__DARKLUA_TYPE_Q = ImageLabel__DARKLUA_TYPE_j & {
	Style: ("Primary" | "Secondary")?,
}

type Symbol__DARKLUA_TYPE_R = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_af & SymbolProperties__DARKLUA_TYPE_Q

type ToggleProperties__DARKLUA_TYPE_S = Frame__DARKLUA_TYPE_g & {
	Value: boolean?,
	ValueChanged: ((self: Toggle__DARKLUA_TYPE_T, value: boolean) -> unknown)?,
}

type Toggle__DARKLUA_TYPE_T = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_af & ToggleProperties__DARKLUA_TYPE_S

type TextFieldProperties__DARKLUA_TYPE_U = Frame__DARKLUA_TYPE_g & {
	Placeholder: string?,
	Value: string?,
	TextChanged: ((self: TextField__DARKLUA_TYPE_V, text: string) -> unknown)?,
	ValueChanged: ((self: TextField__DARKLUA_TYPE_V, value: string) -> unknown)?,
}

type TextField__DARKLUA_TYPE_V = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_af & TextFieldProperties__DARKLUA_TYPE_U

type KeybindFieldProperties__DARKLUA_TYPE_W = Frame__DARKLUA_TYPE_g & {
	Placeholder: string?,
	Value: Enum.KeyCode?,
	BindPressed: ((
		self: KeybindField__DARKLUA_TYPE_X,
		value: Enum.KeyCode,
		inputComplete: boolean,
		gameProcessedEvent: boolean
	) -> unknown)?,
	ValueChanged: ((self: KeybindField__DARKLUA_TYPE_X, value: Enum.KeyCode) -> unknown)?,
}

type KeybindField__DARKLUA_TYPE_X = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_af & KeybindFieldProperties__DARKLUA_TYPE_W

type SliderProperties__DARKLUA_TYPE_Y = ImageLabel__DARKLUA_TYPE_j & {
	Minimum: number?,
	Maximum: number?,
	Value: number?,
	ValueChanged: ((self: Slider__DARKLUA_TYPE_Z, value: number) -> unknown)?,
}

type Slider__DARKLUA_TYPE_Z = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_af & SliderProperties__DARKLUA_TYPE_Y

type ButtonProperties__DARKLUA_TYPE__ = TextButton__DARKLUA_TYPE_l & {
	State: ("Primary" | "Secondary" | "Destructive")?,
	Label: string?,
	Pushed: ((self: Button__DARKLUA_TYPE_0) -> unknown)?,
}

type Button__DARKLUA_TYPE_0 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_af & ButtonProperties__DARKLUA_TYPE__

type StepperProperties__DARKLUA_TYPE_1 = ImageLabel__DARKLUA_TYPE_j & {
	Minimum: number?,
	Maximum: number?,
	Step: number?,
	Fielded: boolean?,
	Value: number?,
	ValueChanged: ((self: Stepper__DARKLUA_TYPE_2, value: number) -> unknown)?,
}

type Stepper__DARKLUA_TYPE_2 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_af & StepperProperties__DARKLUA_TYPE_1 & {
	Increment: () -> nil,
	Decrement: () -> nil,
}

type RadioButtonGroupProperties__DARKLUA_TYPE_3 = Frame__DARKLUA_TYPE_g & {
	Options: { [number]: string }?,
	Value: number?,
	ValueChanged: ((self: RadioButtonGroup__DARKLUA_TYPE_4, value: number) -> unknown)?,
}

type RadioButtonGroup__DARKLUA_TYPE_4 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_af & RadioButtonGroupProperties__DARKLUA_TYPE_3 & {
	Option: (Name: string?) -> Frame__DARKLUA_TYPE_g,
}

type DropdownMenuAnchorConfig__DARKLUA_TYPE_5 = {
...
type DropdownMenuAnchor__DARKLUA_TYPE_6 = GuiObject__DARKLUA_TYPE_e | DropdownMenuAnchorConfig__DARKLUA_TYPE_5

type PopUpButtonProperties__DARKLUA_TYPE_7 = Frame__DARKLUA_TYPE_g & {
	Options: { [number]: string }?,
	Expanded: boolean?,
	Anchor: DropdownMenuAnchor__DARKLUA_TYPE_6?,
	Maximum: number?,
	Value: (number | { number })?,
	ValueChanged: ((self: PopUpButton__DARKLUA_TYPE_8, value: number | { number }) -> unknown)?,
}

type PopUpButton__DARKLUA_TYPE_8 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_af & PopUpButtonProperties__DARKLUA_TYPE_7 & {
	Option: (Name: string?) -> Frame__DARKLUA_TYPE_g,
	Remove: (Index: number?) -> nil,
}

type PullDownButtonProperties__DARKLUA_TYPE_9 = Frame__DARKLUA_TYPE_g & {
	Options: { [number]: string }?,
	Expanded: boolean?,
	Anchor: DropdownMenuAnchor__DARKLUA_TYPE_6?,
	Label: string?,
	Value: number?,
	ValueChanged: ((self: PullDownButton__DARKLUA_TYPE_aa, value: number) -> unknown)?,
}

type PullDownButton__DARKLUA_TYPE_aa = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_af & PullDownButtonProperties__DARKLUA_TYPE_9 & {
	Option: (Name: string?) -> Frame__DARKLUA_TYPE_g,
	Remove: (Index: number?) -> nil,
}

type NotificationProperties__DARKLUA_TYPE_ab = Frame__DARKLUA_TYPE_g & {
	Title: string,
	Subtitle: string,
	App: string?,
	AppIcon: string?,
	Icon: string?,
	Duration: number?,
	Closed: ((self: Notification__DARKLUA_TYPE_ac, fromUserInput: boolean?) -> unknown)?,
}

type Notification__DARKLUA_TYPE_ac = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_af & NotificationProperties__DARKLUA_TYPE_ab & {
	Close: (self: Notification__DARKLUA_TYPE_ac) -> nil,
}

type ImageSurfaceProperties__DARKLUA_TYPE_ad = Frame__DARKLUA_TYPE_g & {
	Image: string?,
	ImageColor: Color3?,
	SurfaceColor: Color3?,
	Gradient: boolean?,
...
type ImageSurface__DARKLUA_TYPE_ae = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_af & ImageSurfaceProperties__DARKLUA_TYPE_ad

type Components__DARKLUA_TYPE_af = {
	Window: (self: any, properties: WindowProperties__DARKLUA_TYPE_w?) -> Window__DARKLUA_TYPE_x,
	Section: (self: any, properties: SectionProperties__DARKLUA_TYPE_y?) -> Section__DARKLUA_TYPE_z,
	Tab: (self: any, properties: TabProperties__DARKLUA_TYPE_A?) -> Tab__DARKLUA_TYPE_B,
	Page: (self: any, properties: PageProperties__DARKLUA_TYPE_M?) -> Page__DARKLUA_TYPE_N,
	Form: (self: any, properties: FormProperties__DARKLUA_TYPE_C?) -> Form__DARKLUA_TYPE_D,
	Row: (self: any, properties: RowProperties__DARKLUA_TYPE_E?) -> Row__DARKLUA_TYPE_F,
	VStack: (self: any, properties: StackProperties__DARKLUA_TYPE_G?) -> Stack__DARKLUA_TYPE_H,
	HStack: (self: any, properties: StackProperties__DARKLUA_TYPE_G?) -> Stack__DARKLUA_TYPE_H,
	TitleStack: (self: any, properties: TitleStackProperties__DARKLUA_TYPE_I?) -> TitleStack__DARKLUA_TYPE_J,
	PageSection: (self: any, properties: PageSectionProperties__DARKLUA_TYPE_K?) -> PageSection__DARKLUA_TYPE_L,
	Label: (self: any, properties: LabelProperties__DARKLUA_TYPE_O) -> Label__DARKLUA_TYPE_P,
	Symbol: (self: any, properties: SymbolProperties__DARKLUA_TYPE_Q) -> Symbol__DARKLUA_TYPE_R,
	Toggle: (self: any, properties: ToggleProperties__DARKLUA_TYPE_S) -> Toggle__DARKLUA_TYPE_T,
	TextField: (self: any, properties: TextFieldProperties__DARKLUA_TYPE_U) -> TextField__DARKLUA_TYPE_V,
	KeybindField: (self: any, properties: KeybindFieldProperties__DARKLUA_TYPE_W) -> KeybindField__DARKLUA_TYPE_X,
	Slider: (self: any, properties: SliderProperties__DARKLUA_TYPE_Y) -> Slider__DARKLUA_TYPE_Z,
	Button: (self: any, properties: ButtonProperties__DARKLUA_TYPE__) -> Button__DARKLUA_TYPE_0,
	Stepper: (self: any, properties: StepperProperties__DARKLUA_TYPE_1) -> Stepper__DARKLUA_TYPE_2,
	RadioButtonGroup: (self: any, properties: RadioButtonGroupProperties__DARKLUA_TYPE_3) -> RadioButtonGroup__DARKLUA_TYPE_4,
	PopUpButton: (self: any, properties: PopUpButtonProperties__DARKLUA_TYPE_7) -> PopUpButton__DARKLUA_TYPE_8,
	PullDownButton: (self: any, properties: PullDownButtonProperties__DARKLUA_TYPE_9) -> PullDownButton__DARKLUA_TYPE_aa,
	Notification: (self: any, properties: NotificationProperties__DARKLUA_TYPE_ab) -> Notification__DARKLUA_TYPE_ac,
	ImageSurface: (self: any, properties: ImageSurfaceProperties__DARKLUA_TYPE_ad) -> ImageSurface__DARKLUA_TYPE_ae,
	ColorPicker: (self: any, properties: any) -> any,
}

--// Types
type DropdownMenuStructureConfig__DARKLUA_TYPE_ag = {
	Name: string?,
}

--// Types
type DropdownMenuConfig__DARKLUA_TYPE_ah = {
	Name: string?,
	Anchor: any?,
	AnchorMode: string?,
	Gap: number?,
...
end function __DIST.m():typeof(__modImpl())local v=__DIST.cache.m if not v then v={c=__modImpl()}__DIST.cache.m=v end return v.c end end do local function __modImpl()-- We uh
-- We dont talk about this..


local types = __DIST.b()

return function(self, properties: WindowProperties__DARKLUA_TYPE_w): Window__DARKLUA_TYPE_x	--// Imports
...
local effects = __DIST.i()
	...
	local windowControls, windowControlsCKeys = __DIST.m()(self, properties)
...
return function(self, properties: SectionProperties__DARKLUA_TYPE_y): Section__DARKLUA_TYPE_z	--// Imports
...
return function(self, properties: PageProperties__DARKLUA_TYPE_M)
	--// Imports
	local creator = __DIST.d()
	local binder = __DIST.c()
...
return function(self, properties: TabProperties__DARKLUA_TYPE_A): Tab__DARKLUA_TYPE_B	--// Imports
...
local creator = __DIST.d()
	...
	object = binder.Wrap(properties, {
		...
		Selected = function(selected: boolean)
			if selected then
				for _, tab: Tab__DARKLUA_TYPE_B in pairs(window.Tabs) do
	...
	object.Navigate = function(self, targetPage: Page__DARKLUA_TYPE_N)
...
return function(self, properties: PageSectionProperties__DARKLUA_TYPE_K): PageSection__DARKLUA_TYPE_L	--// Imports
	
local creator = __DIST.d()
	local binder = __DIST.c()

	local titleStack = __DIST.r()
...
return function(self, properties: Frame__DARKLUA_TYPE_g): Form__DARKLUA_TYPE_D	--// Imports
...
return function(self, properties: RowProperties__DARKLUA_TYPE_E): Row__DARKLUA_TYPE_F	--// Imports
...
return function(self, properties: StackProperties__DARKLUA_TYPE_G): Stack__DARKLUA_TYPE_H	--// Imports
...
return function(self, properties: TitleStackProperties__DARKLUA_TYPE_I): TitleStack__DARKLUA_TYPE_J	--// Imports
...
return function(self, properties: LabelProperties__DARKLUA_TYPE_O): Label__DARKLUA_TYPE_P	--// Imports
...
return function(self, properties: SymbolProperties__DARKLUA_TYPE_Q): Symbol__DARKLUA_TYPE_R	--// Imports
...
return function(self, properties: ToggleProperties__DARKLUA_TYPE_S): Row__DARKLUA_TYPE_F	--// Imports
...
return function(self, properties: TextFieldProperties__DARKLUA_TYPE_U): TextField__DARKLUA_TYPE_V	--// Imports
...
return function(self, properties: KeybindFieldProperties__DARKLUA_TYPE_W): KeybindFieldProperties__DARKLUA_TYPE_W	--// Imports
...
return function(self, properties: SliderProperties__DARKLUA_TYPE_Y): Slider__DARKLUA_TYPE_Z	--// Imports
...
return function(self, properties: ButtonProperties__DARKLUA_TYPE__): Button__DARKLUA_TYPE_0	--// Imports
...
return function(self, properties: StepperProperties__DARKLUA_TYPE_1): Stepper__DARKLUA_TYPE_2	--// Imports
...
return function(self, properties: RadioButtonGroupProperties__DARKLUA_TYPE_3): RadioButtonGroup__DARKLUA_TYPE_4	--// Imports
...
return function(self, config: DropdownMenuStructureConfig__DARKLUA_TYPE_ag?)
	--// Variables
	local create = creator.Create
...
--// Public Methods
function DropdownMenu.new(context, componentStructures, config: DropdownMenuConfig__DARKLUA_TYPE_ah?)
	config = config or {}
...
return function(self, properties: PopUpButtonProperties__DARKLUA_TYPE_7): PopUpButton__DARKLUA_TYPE_8	--// Imports
...
return function(self, properties: PullDownButtonProperties__DARKLUA_TYPE_9): PullDownButton__DARKLUA_TYPE_aa	--// Imports
...
return function(self: any, properties: NotificationProperties__DARKLUA_TYPE_ab, state: { Age: number }, MAX_NOTIFICATIONS: number)
	local creator = __DIST.d()
...
return function(self, properties: NotificationProperties__DARKLUA_TYPE_ab): Notification__DARKLUA_TYPE_ac	
local services = __DIST.e()
	local binder = __DIST.c()
...
return function(self, properties: ImageSurfaceProperties__DARKLUA_TYPE_ad): ImageSurface__DARKLUA_TYPE_ae	--// Imports
