...
type App__DARKLUA_TYPE_r = AppProperties__DARKLUA_TYPE_q & Components__DARKLUA_TYPE_ao
...
type ComponentContext__DARKLUA_TYPE_t = ComponentProperties__DARKLUA_TYPE_s & Components__DARKLUA_TYPE_ao
...
type WindowProperties__DARKLUA_TYPE_x = Frame__DARKLUA_TYPE_g & {
	...
	Hotkey: (boolean | Enum.KeyCode | { [string]: any })?,
	HotkeyKey: Enum.KeyCode?,
...
type Window__DARKLUA_TYPE_y = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & WindowProperties__DARKLUA_TYPE_x & {
	RegisterHotkey: (self: Window__DARKLUA_TYPE_y, id: string, name: string, key: Enum.KeyCode | string, prefix: string?) -> (),
	UnregisterHotkey: (self: Window__DARKLUA_TYPE_y, id: string) -> (),
	UpdateHotkey: (self: Window__DARKLUA_TYPE_y, id: string, key: Enum.KeyCode | string) -> (),
}
...
type Section__DARKLUA_TYPE_A = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & SectionProperties__DARKLUA_TYPE_z
...
type Tab__DARKLUA_TYPE_C = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & TabProperties__DARKLUA_TYPE_B & {
...
type Form__DARKLUA_TYPE_E = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & FormProperties__DARKLUA_TYPE_D

type RowProperties__DARKLUA_TYPE_F = Frame__DARKLUA_TYPE_g & {
	SearchIndex: string?,
}

type Row__DARKLUA_TYPE_G = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & RowProperties__DARKLUA_TYPE_F & {
...
type Stack__DARKLUA_TYPE_I = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & StackProperties__DARKLUA_TYPE_H
...
type TitleStack__DARKLUA_TYPE_K = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & TitleStackProperties__DARKLUA_TYPE_J
...
type PageSection__DARKLUA_TYPE_M = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & PageSectionProperties__DARKLUA_TYPE_L

type PageProperties__DARKLUA_TYPE_N = ScrollingFrame

type Page__DARKLUA_TYPE_O = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & PageProperties__DARKLUA_TYPE_N

type LabelProperties__DARKLUA_TYPE_P = TextLabel__DARKLUA_TYPE_h

type Label__DARKLUA_TYPE_Q = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & LabelProperties__DARKLUA_TYPE_P

type SymbolProperties__DARKLUA_TYPE_R = ImageLabel__DARKLUA_TYPE_j & {
	Style: ("Primary" | "Secondary")?,
}

type Symbol__DARKLUA_TYPE_S = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & SymbolProperties__DARKLUA_TYPE_R
...
type Toggle__DARKLUA_TYPE_U = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & ToggleProperties__DARKLUA_TYPE_T
...
type TextField__DARKLUA_TYPE_W = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & TextFieldProperties__DARKLUA_TYPE_V
...
type KeybindField__DARKLUA_TYPE_Y = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & KeybindFieldProperties__DARKLUA_TYPE_X
...
type Slider__DARKLUA_TYPE__ = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & SliderProperties__DARKLUA_TYPE_Z
...
type Button__DARKLUA_TYPE_1 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & ButtonProperties__DARKLUA_TYPE_0
...
type Stepper__DARKLUA_TYPE_3 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & StepperProperties__DARKLUA_TYPE_2 & {
	Increment: () -> nil,
	Decrement: () -> nil,
}
...
type RadioButtonGroup__DARKLUA_TYPE_5 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & RadioButtonGroupProperties__DARKLUA_TYPE_4 & {
...
type PopUpButton__DARKLUA_TYPE_9 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & PopUpButtonProperties__DARKLUA_TYPE_8 & {
	Option: (Name: string?) -> Frame__DARKLUA_TYPE_g,
...
type PullDownButton__DARKLUA_TYPE_ab = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & PullDownButtonProperties__DARKLUA_TYPE_aa & {
	Option: (Name: string?) -> Frame__DARKLUA_TYPE_g,
	Remove: (Index: number?) -> nil,
}
...
type Notification__DARKLUA_TYPE_ad = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & NotificationProperties__DARKLUA_TYPE_ac & {
...
type ImageSurface__DARKLUA_TYPE_af = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & ImageSurfaceProperties__DARKLUA_TYPE_ae
...
type PieChart__DARKLUA_TYPE_ah = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & PieChartProperties__DARKLUA_TYPE_ag
...
type LineChart__DARKLUA_TYPE_aj = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & LineChartProperties__DARKLUA_TYPE_ai
...
type BarChart__DARKLUA_TYPE_al = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & BarChartProperties__DARKLUA_TYPE_ak

type ShortcutBadgeProperties__DARKLUA_TYPE_am = Frame__DARKLUA_TYPE_g & {
	Key: (Enum.KeyCode | string)?,
	Text: string?,
}

type ShortcutBadge__DARKLUA_TYPE_an = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ao & ShortcutBadgeProperties__DARKLUA_TYPE_am

type Components__DARKLUA_TYPE_ao = {
	...
	ShortcutBadge: (self: any, properties: ShortcutBadgeProperties__DARKLUA_TYPE_am) -> ShortcutBadge__DARKLUA_TYPE_an,
...
--// Types
type DropdownMenuStructureConfig__DARKLUA_TYPE_ap = {
	Name: string?,
}

--// Types
type DropdownMenuConfig__DARKLUA_TYPE_aq = {
	Name: string?,
	Anchor: any?,
	AnchorMode: string?,
	Gap: number?,
...
local function formatKeyText(key: (Enum.KeyCode | string)?): string
...
return function(self, properties: ShortcutBadgeProperties__DARKLUA_TYPE_am?): ShortcutBadge__DARKLUA_TYPE_an	--// Imports
...
local creator = __DIST.d()
	...
	--// UI
	properties = properties or {}
	local initialText = properties.Text or formatKeyText(properties.Key)
	...
	local object = binder.Wrap(properties, {
		Key = function(value)
			local formatted = formatKeyText(value)
			local label = structures.Body:FindFirstChild("KeyLabel")
			if label then
...
return function(self, parent: Instance?)
	local create = creator.Create
	parent = parent or self.__container or self.__instance or self
	...
	function widget:AddHotkey(id: string, name: string, key: Enum.KeyCode | string, prefix: string?)
		if entries[id] then
...
local effects = __DIST.i()
	...
	local createHotkeyWidget = __DIST.r()
	...
	local toggleKey = (typeof(properties.Hotkey) == "EnumItem" and properties.Hotkey) or properties.HotkeyKey or Enum.KeyCode.RightControl

	if properties.Hotkey then
		hotkeyWidget = createHotkeyWidget(self, window.Parent)
		hotkeyWidget:AddHotkey("ui_toggle", "UI Toggle", toggleKey, "Toggle")
	end

	userInputService.InputBegan:Connect(function(input, gpe)
		if gpe then return end
		if properties.Hotkey and input.UserInputType == Enum.UserInputType.Keyboard and input.KeyCode == toggleKey then
			window.Visible = not window.Visible
		end
	end)

	object.RegisterHotkey = function(selfWindow, id: string, name: string, key: Enum.KeyCode | string, prefix: string?)
		if not hotkeyWidget then
			hotkeyWidget = createHotkeyWidget(self, window.Parent)
		end
		hotkeyWidget:AddHotkey(id, name, key, prefix)
	end

	object.UnregisterHotkey = function(selfWindow, id: string)
		if hotkeyWidget then
			hotkeyWidget:RemoveHotkey(id)
		end
	end

	object.UpdateHotkey = function(selfWindow, id: string, key: Enum.KeyCode | string)
		if hotkeyWidget then
			hotkeyWidget:UpdateHotkey(id, key)
		end
	end

	object.__hotkeyWidget = hotkeyWidget
...
local creator = __DIST.d()
	...
	object.__window = self.Type == "Window" and self or self.__window
...
return function(self, properties: SectionProperties__DARKLUA_TYPE_z): Section__DARKLUA_TYPE_A	
if self and (self.Type == "Page" or self.Type == "PageSection") then
		local createPageSection = __DIST.v()
		return createPageSection(self, properties)
	end
...
return function(self, properties: PageProperties__DARKLUA_TYPE_N)
	if self and (self.Type == "Tab" or (typeof(self) == "table" and self.Structures and self.Structures.Page)) and self.__page then
		return self.__page
	end
...
local creator = __DIST.d()
	...
	object.__page = pageComponent
	if pageComponent then
		pageComponent.__window = window
	end
	...
	if window then
		...
		if #window.Tabs == 1 and properties.Selected == nil then
...
local KeybindFieldModule
KeybindFieldModule = function(self, properties: types.KeybindFieldProperties): types.KeybindFieldProperties
	--// Imports
	local binder = __DIST.c()
	local services = __DIST.e()
	...
	if properties.Title and self and self.Type ~= "Row" then
		local createRow = __DIST.A()		
local createTitleStack = __DIST.B()
		
local row = createRow(self, { SearchIndex = properties.Title })
		createTitleStack(row:Left(), {
			Title = properties.Title,
			Subtitle = properties.Subtitle,
		})

		local rightCtx = row:Right()
		rightCtx.__window = self.__window or (self.Type == "Window" and self)

		local propsCopy = table.clone(properties)
		local origTitle = propsCopy.Title
		propsCopy.Title = nil
		propsCopy.Subtitle = nil

		local fieldObj = KeybindFieldModule(rightCtx, propsCopy)

		local window = self.__window or (self.Type == "Window" and self)
		if not window and __SH and __SH.COMPINDEXES then
			for _, comp in ipairs(__SH.COMPINDEXES) do
				if typeof(comp) == "table" and comp.Type == "Window" and comp.RegisterHotkey then
					window = comp
					break
				end
			end
		...
		if window and window.RegisterHotkey and properties.Value then
			window:RegisterHotkey(tostring(propsCopy), origTitle, properties.Value, "Toggle")
		end
	...
	local curr = self
	while curr do
		if curr.Type == "Window" or curr.RegisterHotkey then
			window = curr
			break
		end
		if curr.__window then
			window = curr.__window
			break
		end
		curr = curr.Parent or curr.__parent
	end

	local fieldId = tostring(properties)
	if window and window.RegisterHotkey and properties.Title and properties.Value then
		window:RegisterHotkey(fieldId, properties.Title, properties.Value, "Toggle")
	end
	...
	object = binder.Wrap(properties, {
		...
		Value = function(value: Enum.KeyCode)
			...
			if window and window.UpdateHotkey and properties.Title then
				window:UpdateHotkey(fieldId, value)
			end
...
return function(self, config: DropdownMenuStructureConfig__DARKLUA_TYPE_ap?)
	--// Variables
	local create = creator.Create
...
--// Public Methods
function DropdownMenu.new(context, componentStructures, config: DropdownMenuConfig__DARKLUA_TYPE_aq?)
	config = config or {}
