...
--[[
    ...
    @buildDate "2026-06-20T11:42:35.733324Z"
    @buildCfg "Task"
    @buildVers "0.0.0"
		...
		verifyBtn.Structures.Body.MouseButton1Click:Connect(function()
			...
			if isValid then
				...
				task.delay(1.2, function()
					...
					-- Restore window configurations & sizes
					properties.Resizable = ksOriginalResizable
					properties.Searching = ksOriginalSearching
					properties.CanMinimize = ksOriginalCanMinimize
					properties.CanZoom = ksOriginalCanZoom
					...
					-- Resize Window to original size via tween
					local tweenInfo = TweenInfo.new(0.5, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out)
