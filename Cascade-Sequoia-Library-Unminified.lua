...
--[[
    ...
    @buildDate "2026-06-19T20:17:23.527371400+00:00"
    @buildCfg "Task"
    @buildVers "0.0.0"
...
return function(self, properties: any)
	...
	local function openPopover()
		...
		-- Root popover screen GUI or canvas
		popoverGui = create("ScreenGui")({
			Name = "ColorPickerPopoverGui",
			DisplayOrder = 300,
			IgnoreGuiInset = true,
