...
--[[
    ...
    @buildDate "2026-06-19T20:20:27.696482800+00:00"
    @buildCfg "Task"
    @buildVers "0.0.0"
...
return function(self, properties: any)
	...
	local function openPopover()
		if popoverFrame then return end
		...
		-- Popover Panel (parented directly to the main ScreenGui to avoid permissions errors)
