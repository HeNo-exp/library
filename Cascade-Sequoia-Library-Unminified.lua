...
--[[
    ...
    @buildDate "2026-07-21T23:19:24.345368Z"
    @buildCfg "Task"
    @buildVers "0.0.0"
...
type App__DARKLUA_TYPE_r = AppProperties__DARKLUA_TYPE_q & Components__DARKLUA_TYPE_am
...
type ComponentContext__DARKLUA_TYPE_t = ComponentProperties__DARKLUA_TYPE_s & Components__DARKLUA_TYPE_am
...
type Window__DARKLUA_TYPE_y = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & WindowProperties__DARKLUA_TYPE_x & {
	AddHotkey: (self: Window__DARKLUA_TYPE_y, id: string, name: string, key: Enum.KeyCode | string, prefix: string?) -> nil,
	RemoveHotkey: (self: Window__DARKLUA_TYPE_y, id: string) -> nil,
	UpdateHotkey: (self: Window__DARKLUA_TYPE_y, newKey: Enum.KeyCode | string) -> nil,
	SetHotkeyVisible: (self: Window__DARKLUA_TYPE_y, visible: boolean) -> nil,
}
...
type Section__DARKLUA_TYPE_A = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & SectionProperties__DARKLUA_TYPE_z
...
type Tab__DARKLUA_TYPE_C = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & TabProperties__DARKLUA_TYPE_B & {
...
type Form__DARKLUA_TYPE_E = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & FormProperties__DARKLUA_TYPE_D

type RowProperties__DARKLUA_TYPE_F = Frame__DARKLUA_TYPE_g & {
	SearchIndex: string?,
}

type Row__DARKLUA_TYPE_G = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & RowProperties__DARKLUA_TYPE_F & {
...
type Stack__DARKLUA_TYPE_I = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & StackProperties__DARKLUA_TYPE_H
...
type TitleStack__DARKLUA_TYPE_K = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & TitleStackProperties__DARKLUA_TYPE_J
...
type PageSection__DARKLUA_TYPE_M = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & PageSectionProperties__DARKLUA_TYPE_L

type PageProperties__DARKLUA_TYPE_N = ScrollingFrame

type Page__DARKLUA_TYPE_O = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & PageProperties__DARKLUA_TYPE_N

type LabelProperties__DARKLUA_TYPE_P = TextLabel__DARKLUA_TYPE_h

type Label__DARKLUA_TYPE_Q = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & LabelProperties__DARKLUA_TYPE_P

type SymbolProperties__DARKLUA_TYPE_R = ImageLabel__DARKLUA_TYPE_j & {
	Style: ("Primary" | "Secondary")?,
}

type Symbol__DARKLUA_TYPE_S = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & SymbolProperties__DARKLUA_TYPE_R
...
type Toggle__DARKLUA_TYPE_U = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & ToggleProperties__DARKLUA_TYPE_T
...
type TextField__DARKLUA_TYPE_W = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & TextFieldProperties__DARKLUA_TYPE_V
...
type KeybindField__DARKLUA_TYPE_Y = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & KeybindFieldProperties__DARKLUA_TYPE_X
...
type Slider__DARKLUA_TYPE__ = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & SliderProperties__DARKLUA_TYPE_Z
...
type Button__DARKLUA_TYPE_1 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & ButtonProperties__DARKLUA_TYPE_0
...
type Stepper__DARKLUA_TYPE_3 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & StepperProperties__DARKLUA_TYPE_2 & {
	Increment: () -> nil,
	Decrement: () -> nil,
}
...
type RadioButtonGroup__DARKLUA_TYPE_5 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & RadioButtonGroupProperties__DARKLUA_TYPE_4 & {
...
type PopUpButton__DARKLUA_TYPE_9 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & PopUpButtonProperties__DARKLUA_TYPE_8 & {
	Option: (Name: string?) -> Frame__DARKLUA_TYPE_g,
...
type PullDownButton__DARKLUA_TYPE_ab = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & PullDownButtonProperties__DARKLUA_TYPE_aa & {
	Option: (Name: string?) -> Frame__DARKLUA_TYPE_g,
	Remove: (Index: number?) -> nil,
}
...
type Notification__DARKLUA_TYPE_ad = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & NotificationProperties__DARKLUA_TYPE_ac & {
...
type ImageSurface__DARKLUA_TYPE_af = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & ImageSurfaceProperties__DARKLUA_TYPE_ae
...
type PieChart__DARKLUA_TYPE_ah = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & PieChartProperties__DARKLUA_TYPE_ag
...
type LineChart__DARKLUA_TYPE_aj = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & LineChartProperties__DARKLUA_TYPE_ai
...
type BarChart__DARKLUA_TYPE_al = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_am & BarChartProperties__DARKLUA_TYPE_ak

type Components__DARKLUA_TYPE_am = {
	...
	ShortcutBadge: (self: any, properties: any) -> any,
}

--// Types
type DropdownMenuStructureConfig__DARKLUA_TYPE_an = {
	Name: string?,
}

--// Types
type DropdownMenuConfig__DARKLUA_TYPE_ao = {
	Name: string?,
	Anchor: any?,
	AnchorMode: string?,
	Gap: number?,
...
return function(self, properties: any)
	...
	--// Variables
	local parent = properties and properties.Parent or (self and (self.__container or self.__instance or self))
	local structures = {}

	--// UI
	properties = properties or {}
	properties.Key = properties.Key or "None"

	structures.Body = create("Frame")({
		Name = "ShortcutBadge",
		AutomaticSize = Enum.AutomaticSize.XY,
		BackgroundColor3 = Color3.fromRGB(35, 38, 46),
		BackgroundTransparency = 0.2,
		BorderSizePixel = 0,
		Parent = properties.Parent or parent,
	...
	object = binder.Wrap(properties, {
		Key = function(value)
			local label = structures.Body:FindFirstChild("BadgeLabel")
			if label then
...
local creator = __DIST.d()
local binder = __DIST.c()
local createShortcutBadge = __DIST.h()

return function(self, parent: Instance?)
	local create = creator.Create
	parent = parent or (self and (self.__container or self.__instance or self))
	...
	function widget:AddHotkey(id: string, name: string, key: Enum.KeyCode | string, prefix: string?)
		...
		local badge = createShortcutBadge(self, {
			Key = key,
			Parent = row.__instance or row,
		})

		local badgeInstance = badge and badge.Structures and badge.Structures.Body
		if badgeInstance then
			badgeInstance.AnchorPoint = Vector2.new(1, 0.5)
			badgeInstance.Position = UDim2.new(1, 0, 0.5, 0)
		end
	...
	function widget:RemoveHotkey(id: string)
		...
		if entry then
			if entry.Row then
				local rowInst = entry.Row.__instance or entry.Row
				if rowInst and rowInst.Destroy then
					rowInst:Destroy()
				end
			end
			entries[id] = nil
...
local binder = __DIST.c()
	...
	--// Variables
	local structures = __DIST.l()(self)
...
local types = __DIST.b()
local createHotkeyWidget = __DIST.i()

return function(self, properties: WindowProperties__DARKLUA_TYPE_x): Window__DARKLUA_TYPE_y	--// Imports
	
local effects = __DIST.k()
	local services = __DIST.e()
	local creator = __DIST.d()
	local binder = __DIST.c()
	local utility = __DIST.a()

	local titleBar, addToHistory = __DIST.m()(self)
	local resizeHandler = __DIST.n()

	local symbols = __DIST.g()
	local createVStack = __DIST.o()
	local createHStack = __DIST.p()
	local createTextField = __DIST.q()
	local createButton = __DIST.r()
	...
	properties.Hotkey = properties.Hotkey == true or properties.Hotkeys == true
	...
	local bindings = {
		...
		Hotkey = function(value: boolean)
			properties.Hotkey = value
			if value and not structures.HotkeyWidget then
				structures.HotkeyWidget = createHotkeyWidget(self, window)
			elseif structures.HotkeyWidget then
				structures.HotkeyWidget:SetVisible(value)
			end
		end,
		Hotkeys = function(value: boolean)
			if bindings.Hotkey then
				bindings.Hotkey(value)
			end
		end,
	}
	...
	function object:AddHotkey(id: string, name: string, key: Enum.KeyCode | string, prefix: string?)
		if not structures.HotkeyWidget then
			structures.HotkeyWidget = createHotkeyWidget(self, window)
		end
		structures.HotkeyWidget:AddHotkey(id, name, key, prefix)
	end

	function object:RemoveHotkey(id: string)
		if structures.HotkeyWidget then
			structures.HotkeyWidget:RemoveHotkey(id)
		end
	end

	function object:UpdateHotkey(id: string, newKey: Enum.KeyCode | string)
		if structures.HotkeyWidget then
			structures.HotkeyWidget:UpdateHotkey(id, newKey)
		end
	end

	function object:SetHotkeyVisible(visible: boolean)
		if structures.HotkeyWidget then
			structures.HotkeyWidget:SetVisible(visible)
		end
	end
...
return function(self, properties: TabProperties__DARKLUA_TYPE_B): Tab__DARKLUA_TYPE_C	
local binder = __DIST.c()

	properties = properties or {}
	local structures = {}

	local object = binder.Wrap(properties, {}, nil)
	object.Type = "Tab"
	object.Theme = self and self.Theme
	object.Structures = structures
...
end function __DIST.H():typeof(__modImpl())local v=__DIST.cache.H if not v then v={c=__modImpl()}__DIST.cache.H=v end return v.c end end do local function __modImpl()--// Imports
...
return function(self, config: DropdownMenuStructureConfig__DARKLUA_TYPE_an?)
	--// Variables
	local create = creator.Create
...
local createStructure = __DIST.I()
local services = __DIST.e()
local utility = __DIST.a()
...
--// Public Methods
function DropdownMenu.new(context, componentStructures, config: DropdownMenuConfig__DARKLUA_TYPE_ao?)
	config = config or {}
...
,
	...
	TextField = __DIST.q()
,
	KeybindField = __DIST.E(),
	Slider = __DIST.F(),
	Button = __DIST.r()
,
	Stepper = __DIST.G(),
	RadioButtonGroup = __DIST.H(),
	PopUpButton = __DIST.K(),
	PullDownButton = __DIST.L(),
	Page = __DIST.M(),
