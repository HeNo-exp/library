...
--[[
    ...
    @buildDate "2026-06-21T00:18:15.857442Z"
    @buildCfg "Task"
    @buildVers "0.0.0"
...
local creator = __DIST.d()
	...
	-- Inner wrapper that will animate (scale & rotate)
	...
	structures.WedgeWrapper = wrapper
	...
	if totalSum <= 0 then
		...
		for _, item in ipairs(properties.Data) do
			...
			if val > 0 then
				...
				drawWedge(wrapper, currentAngle, sweep, item.Color or Color3.fromRGB(255, 255, 255))
	...
	tweenService:Create(getRaw(wrapper), TweenInfo.new(0.8, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
		Size = UDim2.fromScale(1, 1),
		Rotation = 0,
	}):Play()
	...
	local function drawChart()
		...
		for i = 1, n - 1 do
			...
			task.delay((i - 1) * 0.05, function()
				tweenService:Create(getRaw(chartLine), TweenInfo.new(0.5, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
		...
		for i = 1, n do
			...
			task.delay((i - 1) * 0.05, function()
				tweenService:Create(getRaw(dot), TweenInfo.new(0.5, Enum.EasingStyle.Back, Enum.EasingDirection.Out), {
					Size = UDim2.fromOffset(8, 8),
				}):Play()
			end)
...
local creator = __DIST.d()
	...
	local function drawChart()
		...
		for i, item in ipairs(data) do
			...
			tweenService:Create(getRaw(bar), TweenInfo.new(0.8, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
