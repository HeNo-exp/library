...
--[[
    ...
    @buildDate "2026-06-20T17:15:07.547853Z"
    @buildCfg "Release"
    @buildVers "1.2.0"
...
local creator = __DIST.d()
	...
	local function drawWedge(containerFrame, startAngle, sweepAngle, color)
		...
		local function createHalfWedge(parentFrame, rotationAngle)
			...
			local circle = create("ImageLabel")({
				...
				Position = UDim2.fromScale(-1, 0),
				BackgroundTransparency = 1,
				Image = "rbxassetid://93520763686656", -- standard white circle
				ImageColor3 = color,
	...
	legendStack.Structures.Body.Parent = getRaw(structures.Body)
...
local creator = __DIST.d()
	...
	-- Sub-container for visual rendering (will be wiped and rebuilt on resize/update)
	...
	local function drawChart()
		...
		-- 1. Draw horizontal reference grid lines (0%, 50%, 100% of plot height)
...
local creator = __DIST.d()
	...
	-- Sub-container for visual rendering
	local renderArea = create("Frame")({
		Name = "RenderArea",
		Size = UDim2.fromScale(1, 1),
		BackgroundTransparency = 1,
