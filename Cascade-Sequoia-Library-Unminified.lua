...
--[[
    ...
    @buildDate "2026-06-20T01:06:38.731229900+00:00"
    @buildCfg "Task"
    @buildVers "0.0.0"
...
return function(self, properties: any)
	...
	local function openPopover()
		...
		local ok, err = xpcall(function()
			...
			-- 3. Middle Split (Visual Spec & Inputs Frame)
			local middleSplit = Instance.new("Frame")
			middleSplit.Name = "MiddleSplit"
			middleSplit.Size = UDim2.new(1, 0, 0, 130)
			...
			-- Left Visual Spec ImageLabel
			local visualSpec = Instance.new("ImageLabel")
			visualSpec.Name = "VisualSpec"
			visualSpec.Size = UDim2.fromOffset(110, 130)
			visualSpec.BackgroundColor3 = tempColor
			visualSpec.BackgroundTransparency = tempTransparency
			visualSpec.Image = "rbxassetid://143370504"
			visualSpec.ImageTransparency = 0.2
			visualSpec.LayoutOrder = 1
			visualSpec.Parent = middleSplit

			local specCorner = Instance.new("UICorner")
			specCorner.CornerRadius = UDim.new(0, 6)
			specCorner.Parent = visualSpec

			local specStroke = Instance.new("UIStroke")
			specStroke.Color = Color3.fromRGB(255, 255, 255)
			specStroke.Transparency = 0.8
			specStroke.Parent = visualSpec

			-- Right Inputs Frame
			local inputsFrame = Instance.new("Frame")
			inputsFrame.Name = "InputsFrame"
			inputsFrame.Size = UDim2.new(1, -120, 1, 0)
			...
			local function createPureInputField(labelText, defaultValue, layoutOrder, parentFrame)
				...
				fieldFrame.Size = UDim2.new(1, 0, 0, 24)
			...
			sliderFrame.Name = "TransparencySlider"
			...
			thumb.Position = UDim2.new(1 - tempTransparency, 0, 0.5, 0)
			...
			newColorBar.Size = UDim2.new(0.5, -2, 1, 0)
			newColorBar.BackgroundColor3 = tempColor
			newColorBar.BackgroundTransparency = tempTransparency
			newColorBar.LayoutOrder = 1
			newColorBar.Parent = previewsFrame
			...
			originalColorBar.Size = UDim2.new(0.5, -2, 1, 0)
			originalColorBar.BackgroundColor3 = originalColor
			originalColorBar.BackgroundTransparency = originalTransparency
			originalColorBar.LayoutOrder = 2
			originalColorBar.Parent = previewsFrame
			...
			visualSpec:GetPropertyChangedSignal("BackgroundColor3"):Connect(function()
				newColorBar.BackgroundColor3 = visualSpec.BackgroundColor3
			end)
			visualSpec:GetPropertyChangedSignal("BackgroundTransparency"):Connect(function()
				newColorBar.BackgroundTransparency = visualSpec.BackgroundTransparency
			end)
			...
			local popoverWidth = 260
			local popoverHeight = 320
