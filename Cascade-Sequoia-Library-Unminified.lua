...
--[[
    ...
    @buildDate "2026-06-20T17:57:39.105727Z"
    @buildCfg "Release"
    @buildVers "1.2.0"
...
local creator = __DIST.d()
	...
	-- Left Y-axis labels container (reserved width: 35px) - pushed down by 12px (subtitle size)
	local yAxisContainer = create("Frame")({
		Name = "YAxis",
		Size = UDim2.new(0, 35, 1, -12),
	...
	-- Sub-container for visual rendering (shifted to the right by 35px) - pushed down by 12px (subtitle size)
	local renderArea = create("Frame")({
		Name = "RenderArea",
		Size = UDim2.new(1, -35, 1, -12),
