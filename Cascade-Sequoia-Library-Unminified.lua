...
--[[
    ...
    @buildDate "2026-07-22T05:52:12.470869Z"
    @buildCfg "Task"
    @buildVers "0.0.0"
...
local binder = __DIST.c()
	...
	-- Handle automatic Hotkey registration if specified
	if properties.Hotkey and window and window.HotkeyWidget then
		local hotkeyInfo = properties.Hotkey
		hotkeyId = (type(hotkeyInfo) == "table" and hotkeyInfo.Id) or properties.Id or ("keybind_" .. tostring(math.random(100, 999)))
		local hotkeyName = (type(hotkeyInfo) == "table" and hotkeyInfo.Name) or properties.Placeholder or "Keybind"
		local hotkeyPrefix = (type(hotkeyInfo) == "table" and hotkeyInfo.Prefix) or "Toggle"
