...
--[[
    ...
    @buildDate "2026-06-21T00:58:13.668303Z"
    @buildCfg "Task"
    @buildVers "0.0.0"
	...
	object = binder.Wrap(properties, {
		...
		Selected = function(selected: boolean)
			...
			if selected and tabAnim == "move" and window and window.Structures.TabMoveIndicator then
				...
				local lastY, lastX, lastW, lastH = nil, nil, nil, nil
				local function updatePos(instant)
					...
					local localY = tabBody.AbsolutePosition.Y - sidebarList.AbsolutePosition.Y + sidebarList.CanvasPosition.Y
					local localX = tabBody.AbsolutePosition.X - sidebarList.AbsolutePosition.X
					local width = tabBody.AbsoluteSize.X
					local height = tabBody.AbsoluteSize.Y
					
					if localY == lastY and localX == lastX and width == lastW and height == lastH then
						return
					end
					lastY, lastX, lastW, lastH = localY, localX, width, height
				...
				updatePos(not indicator.Visible)
