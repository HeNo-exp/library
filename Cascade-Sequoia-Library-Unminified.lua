...
--[[
    ...
    @buildDate "2026-07-21T23:27:36.752299Z"
    @buildCfg "Task"
    @buildVers "0.0.0"
...
end function __DIST.q():typeof(__modImpl())local v=__DIST.cache.q if not v then v={c=__modImpl()}__DIST.cache.q=v end return v.c end end do local function __modImpl()-- We uh
...
local effects = __DIST.i()
	...
	local windowControls, windowControlsCKeys = __DIST.q()(self, properties)
...
end function __DIST.G():typeof(__modImpl())local v=__DIST.cache.G if not v then v={c=__modImpl()}__DIST.cache.G=v end return v.c end end do local function __modImpl()--// Imports
...
local createStructure = __DIST.H()
local services = __DIST.e()
local utility = __DIST.a()
...
local services = __DIST.e()
	local binder = __DIST.c()
	local notificationList = __DIST.L()
	local ui = __DIST.M()
...
end function __DIST.T():typeof(__modImpl())local v=__DIST.cache.T if not v then v={c=__modImpl()}__DIST.cache.T=v end return v.c end end do local function __modImpl()--// Imports
...
,
	...
	TextField = __DIST.o()
,
	KeybindField = __DIST.D(),
	Slider = __DIST.E(),
	Button = __DIST.p()
,
	Stepper = __DIST.F(),
	RadioButtonGroup = __DIST.G(),
	PopUpButton = __DIST.J(),
	PullDownButton = __DIST.K(),
	Page = __DIST.t()
,
	Notification = __DIST.N(),
	ImageSurface = __DIST.P(),
	ColorPicker = __DIST.Q(),
	PieChart = __DIST.R(),
	LineChart = __DIST.S(),
	BarChart = __DIST.T(),
}
...
return components
end function __DIST.U():typeof(__modImpl())local v=__DIST.cache.U if not v then v={c=__modImpl()}__DIST.cache.U=v end return v.c end end do local function __modImpl()--// Imports
local creator = __DIST.d()
...
end function __DIST.W():typeof(__modImpl())local v=__DIST.cache.W if not v then v={c=__modImpl()}__DIST.cache.W=v end return v.c end end do local function __modImpl()return {
	Dark = __DIST.V(),
	Light = __DIST.W(),
}
end function __DIST.X():typeof(__modImpl())local v=__DIST.cache.X if not v then v={c=__modImpl()}__DIST.cache.X=v end return v.c end end do local function __modImpl()--// Private Methods
...
}end function __DIST.Y():typeof(__modImpl())local v=__DIST.cache.Y if not v then v={c=__modImpl()}__DIST.cache.Y=v end return v.c end end end--// Imports
local utility = __DIST.a()
local types = __DIST.b()
local creator = __DIST.d()
local binder = __DIST.c()
...
local symbols = __DIST.g()
local components = __DIST.U()

local themes = __DIST.X()
local accents = __DIST.Y()
