...
--[[
    ...
    @buildDate "2026-07-23T08:11:17.721714Z"
    @buildCfg "Task"
    @buildVers "0.0.0"
...
type App__DARKLUA_TYPE_r = AppProperties__DARKLUA_TYPE_q & Components__DARKLUA_TYPE_ar
...
type ComponentContext__DARKLUA_TYPE_t = ComponentProperties__DARKLUA_TYPE_s & Components__DARKLUA_TYPE_ar

type AppDumpOptions__DARKLUA_TYPE_u = {
	IncludeInstanceProperties: boolean?,
	IncludeInstanceTree: boolean?,
	Reset: boolean?,
}

type AppRecorder__DARKLUA_TYPE_v = {
	Active: boolean,
	App: App__DARKLUA_TYPE_r,

	Start: (self: AppRecorder__DARKLUA_TYPE_v, options: AppDumpOptions__DARKLUA_TYPE_u?) -> AppRecorder__DARKLUA_TYPE_v,
	Stop: (self: AppRecorder__DARKLUA_TYPE_v) -> AppRecorder__DARKLUA_TYPE_v,
	Clear: (self: AppRecorder__DARKLUA_TYPE_v) -> AppRecorder__DARKLUA_TYPE_v,
	Dump: (self: AppRecorder__DARKLUA_TYPE_v, options: AppDumpOptions__DARKLUA_TYPE_u?) -> string,
}

type KeySystemProperties__DARKLUA_TYPE_w = {
	Service: string,
	Identifier: string,
	Provider: string?,
	OnVerified: (() -> ())?,
...
type WindowProperties__DARKLUA_TYPE_x = Frame__DARKLUA_TYPE_g & {
	Searching: boolean?,
	Draggable: boolean?,
	Resizable: boolean?,
	Title: string?,
	...
	Dropshadow: boolean?,
	UIBlur: boolean?,
	KeySystem: KeySystemProperties__DARKLUA_TYPE_w?,

	TitleTag: string?,
	TitleTagColor: (Color3 | ColorSequence | { Color3 })?,
	TitleTagTextColor: Color3?,
	SubtitleTag: string?,
	SubtitleTagColor: (Color3 | ColorSequence | { Color3 })?,
	SubtitleTagTextColor: Color3?,
	Hotkey: (boolean | { [any]: any })?,
}

type Window__DARKLUA_TYPE_y = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & WindowProperties__DARKLUA_TYPE_x & {
	HotkeyWidget: Hotkey__DARKLUA_TYPE_aq?,
	AddHotkey: (
		self: Window__DARKLUA_TYPE_y,
		id: string,
		name: string,
		key: Enum.KeyCode | string,
		prefix: string?,
		callback: (((Enum.KeyCode) -> ()) | any)?,
		options: any?
	) -> HotkeyEntry__DARKLUA_TYPE_ap,
}

type SectionProperties__DARKLUA_TYPE_z = Frame__DARKLUA_TYPE_g & {
	Title: string?,
	Disclosure: boolean?,
	Expanded: boolean?,
}

type Section__DARKLUA_TYPE_A = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & SectionProperties__DARKLUA_TYPE_z

type TabProperties__DARKLUA_TYPE_B = Frame__DARKLUA_TYPE_g & {
	Title: string?,
	Icon: string?,
	Indentation: number?,
	Selected: boolean?,
	Page: Page__DARKLUA_TYPE_O?,
}

type Tab__DARKLUA_TYPE_C = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & TabProperties__DARKLUA_TYPE_B & {
	Navigate: (self: Tab__DARKLUA_TYPE_C, page: Page__DARKLUA_TYPE_O) -> nil,
	Structures: { [string]: Instance__DARKLUA_TYPE_b | { any }, Page: Page__DARKLUA_TYPE_O},
}

type FormProperties__DARKLUA_TYPE_D = Frame__DARKLUA_TYPE_g

type Form__DARKLUA_TYPE_E = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & FormProperties__DARKLUA_TYPE_D

type RowProperties__DARKLUA_TYPE_F = Frame__DARKLUA_TYPE_g & {
	SearchIndex: string?,
}

type Row__DARKLUA_TYPE_G = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & RowProperties__DARKLUA_TYPE_F & {
	Left: (self: Row__DARKLUA_TYPE_G) -> Row__DARKLUA_TYPE_G,
	Right: (self: Row__DARKLUA_TYPE_G) -> Row__DARKLUA_TYPE_G,
}

type StackProperties__DARKLUA_TYPE_H = Frame__DARKLUA_TYPE_g & {
	Padding: UDim?,
	HorizontalAlignment: Enum.HorizontalAlignment?,
	VerticalAlignment: Enum.VerticalAlignment?,
}

type Stack__DARKLUA_TYPE_I = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & StackProperties__DARKLUA_TYPE_H

type TitleStackProperties__DARKLUA_TYPE_J = Frame__DARKLUA_TYPE_g & {
	Title: string?,
	Subtitle: string?,
...
type TitleStack__DARKLUA_TYPE_K = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & TitleStackProperties__DARKLUA_TYPE_J

type PageSectionProperties__DARKLUA_TYPE_L = Frame__DARKLUA_TYPE_g & {
	Title: string?,
	Subtitle: string?,
...
type PageSection__DARKLUA_TYPE_M = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & PageSectionProperties__DARKLUA_TYPE_L

type PageProperties__DARKLUA_TYPE_N = ScrollingFrame

type Page__DARKLUA_TYPE_O = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & PageProperties__DARKLUA_TYPE_N

type LabelProperties__DARKLUA_TYPE_P = TextLabel__DARKLUA_TYPE_h

type Label__DARKLUA_TYPE_Q = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & LabelProperties__DARKLUA_TYPE_P

type SymbolProperties__DARKLUA_TYPE_R = ImageLabel__DARKLUA_TYPE_j & {
	Style: ("Primary" | "Secondary")?,
}

type Symbol__DARKLUA_TYPE_S = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & SymbolProperties__DARKLUA_TYPE_R

type ToggleProperties__DARKLUA_TYPE_T = Frame__DARKLUA_TYPE_g & {
	Value: boolean?,
	ValueChanged: ((self: Toggle__DARKLUA_TYPE_U, value: boolean) -> unknown)?,
}

type Toggle__DARKLUA_TYPE_U = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & ToggleProperties__DARKLUA_TYPE_T

type TextFieldProperties__DARKLUA_TYPE_V = Frame__DARKLUA_TYPE_g & {
	Placeholder: string?,
	Value: string?,
	TextChanged: ((self: TextField__DARKLUA_TYPE_W, text: string) -> unknown)?,
	ValueChanged: ((self: TextField__DARKLUA_TYPE_W, value: string) -> unknown)?,
}

type TextField__DARKLUA_TYPE_W = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & TextFieldProperties__DARKLUA_TYPE_V

type KeybindFieldProperties__DARKLUA_TYPE_X = Frame__DARKLUA_TYPE_g & {
	Placeholder: string?,
	Value: Enum.KeyCode?,
	BindPressed: ((
		self: KeybindField__DARKLUA_TYPE_Y,
		value: Enum.KeyCode,
		inputComplete: boolean,
		gameProcessedEvent: boolean
	) -> unknown)?,
	ValueChanged: ((self: KeybindField__DARKLUA_TYPE_Y, value: Enum.KeyCode) -> unknown)?,
	Hotkey: (boolean | { Id: string, Name: string, Prefix: string? })?,
}

type KeybindField__DARKLUA_TYPE_Y = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & KeybindFieldProperties__DARKLUA_TYPE_X

type SliderProperties__DARKLUA_TYPE_Z = ImageLabel__DARKLUA_TYPE_j & {
	Minimum: number?,
	Maximum: number?,
	Value: number?,
	ValueChanged: ((self: Slider__DARKLUA_TYPE__, value: number) -> unknown)?,
}

type Slider__DARKLUA_TYPE__ = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & SliderProperties__DARKLUA_TYPE_Z

type ButtonProperties__DARKLUA_TYPE_0 = TextButton__DARKLUA_TYPE_l & {
	State: ("Primary" | "Secondary" | "Destructive")?,
	Label: string?,
	Pushed: ((self: Button__DARKLUA_TYPE_1) -> unknown)?,
}

type Button__DARKLUA_TYPE_1 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & ButtonProperties__DARKLUA_TYPE_0

type StepperProperties__DARKLUA_TYPE_2 = ImageLabel__DARKLUA_TYPE_j & {
	Minimum: number?,
	Maximum: number?,
	Step: number?,
	Fielded: boolean?,
	Value: number?,
	ValueChanged: ((self: Stepper__DARKLUA_TYPE_3, value: number) -> unknown)?,
}

type Stepper__DARKLUA_TYPE_3 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & StepperProperties__DARKLUA_TYPE_2 & {
	Increment: () -> nil,
	Decrement: () -> nil,
}

type RadioButtonGroupProperties__DARKLUA_TYPE_4 = Frame__DARKLUA_TYPE_g & {
	Options: { [number]: string }?,
	Value: number?,
	ValueChanged: ((self: RadioButtonGroup__DARKLUA_TYPE_5, value: number) -> unknown)?,
}

type RadioButtonGroup__DARKLUA_TYPE_5 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & RadioButtonGroupProperties__DARKLUA_TYPE_4 & {
	Option: (Name: string?) -> Frame__DARKLUA_TYPE_g,
}

type DropdownMenuAnchorConfig__DARKLUA_TYPE_6 = {
	Object: GuiObject__DARKLUA_TYPE_e?,
	Element: GuiObject__DARKLUA_TYPE_e?,
	Label: GuiObject__DARKLUA_TYPE_e?,
	Option: number?,
	Offset: Vector2?,
	XOffset: number?,
	YOffset: number?,
...
type DropdownMenuAnchor__DARKLUA_TYPE_7 = GuiObject__DARKLUA_TYPE_e | DropdownMenuAnchorConfig__DARKLUA_TYPE_6

type PopUpButtonProperties__DARKLUA_TYPE_8 = Frame__DARKLUA_TYPE_g & {
	Options: { [number]: string }?,
	Expanded: boolean?,
	Anchor: DropdownMenuAnchor__DARKLUA_TYPE_7?,
	Maximum: number?,
	Value: (number | { number })?,
	ValueChanged: ((self: PopUpButton__DARKLUA_TYPE_9, value: number | { number }) -> unknown)?,
}

type PopUpButton__DARKLUA_TYPE_9 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & PopUpButtonProperties__DARKLUA_TYPE_8 & {
	Option: (Name: string?) -> Frame__DARKLUA_TYPE_g,
	Remove: (Index: number?) -> nil,
}

type PullDownButtonProperties__DARKLUA_TYPE_aa = Frame__DARKLUA_TYPE_g & {
	Options: { [number]: string }?,
	Expanded: boolean?,
	Anchor: DropdownMenuAnchor__DARKLUA_TYPE_7?,
	Label: string?,
	Value: number?,
	ValueChanged: ((self: PullDownButton__DARKLUA_TYPE_ab, value: number) -> unknown)?,
}

type PullDownButton__DARKLUA_TYPE_ab = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & PullDownButtonProperties__DARKLUA_TYPE_aa & {
	Option: (Name: string?) -> Frame__DARKLUA_TYPE_g,
	Remove: (Index: number?) -> nil,
}

type NotificationProperties__DARKLUA_TYPE_ac = Frame__DARKLUA_TYPE_g & {
	Title: string,
	Subtitle: string,
	App: string?,
	AppIcon: string?,
	Icon: string?,
	Duration: number?,
	Closed: ((self: Notification__DARKLUA_TYPE_ad, fromUserInput: boolean?) -> unknown)?,
}

type Notification__DARKLUA_TYPE_ad = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & NotificationProperties__DARKLUA_TYPE_ac & {
	Close: (self: Notification__DARKLUA_TYPE_ad) -> nil,
}

type ImageSurfaceProperties__DARKLUA_TYPE_ae = Frame__DARKLUA_TYPE_g & {
	Image: string?,
	ImageColor: Color3?,
	SurfaceColor: Color3?,
	Gradient: boolean?,
...
type ImageSurface__DARKLUA_TYPE_af = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & ImageSurfaceProperties__DARKLUA_TYPE_ae

type PieChartProperties__DARKLUA_TYPE_ag = {
	Size: number?,
	Donut: boolean?,
	Data: { { Value: number, Color: Color3, Label: string? } },
	Title: string?,
	Subtitle: string?,
	Align: ("Left" | "Right")?,
}

type PieChart__DARKLUA_TYPE_ah = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & PieChartProperties__DARKLUA_TYPE_ag

type LineChartProperties__DARKLUA_TYPE_ai = {
	Height: number?,
	Data: { number },
	Labels: { string }?,
	Color: Color3?,
...
type LineChart__DARKLUA_TYPE_aj = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & LineChartProperties__DARKLUA_TYPE_ai

type BarChartProperties__DARKLUA_TYPE_ak = {
	Height: number?,
	Data: { { Value: number, Color: Color3?, Label: string? } },
	Title: string?,
	Subtitle: string?,
...
type BarChart__DARKLUA_TYPE_al = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & BarChartProperties__DARKLUA_TYPE_ak

type ShortcutBadgeProperties__DARKLUA_TYPE_am = TextButton__DARKLUA_TYPE_l & {
	Key: (Enum.KeyCode | string)?,
	Changed: ((newKey: Enum.KeyCode) -> unknown)?,
	ValueChanged: ((self: ShortcutBadge__DARKLUA_TYPE_an, newKey: Enum.KeyCode) -> unknown)?,
}

type ShortcutBadge__DARKLUA_TYPE_an = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & ShortcutBadgeProperties__DARKLUA_TYPE_am

type HotkeyProperties__DARKLUA_TYPE_ao = Frame__DARKLUA_TYPE_g & {
	Title: string?,
}

type HotkeyEntry__DARKLUA_TYPE_ap = {
	Id: string,
	Name: string,
	Prefix: string?,
	Key: Enum.KeyCode | string,
	Row: any,
	Badge: ShortcutBadge__DARKLUA_TYPE_an,
	Callback: ((Enum.KeyCode) -> ())?,
	KeybindField: any?,
}

type Hotkey__DARKLUA_TYPE_aq = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_ar & HotkeyProperties__DARKLUA_TYPE_ao & {
	Entries: { [string]: HotkeyEntry__DARKLUA_TYPE_ap },
	AddHotkey: (
		self: Hotkey__DARKLUA_TYPE_aq,
		id: string,
		name: string,
		key: Enum.KeyCode | string,
		prefix: string?,
	...
	RemoveHotkey: (self: Hotkey__DARKLUA_TYPE_aq, id: string) -> nil,
	UpdateHotkey: (self: Hotkey__DARKLUA_TYPE_aq, id: string, newKey: Enum.KeyCode | string) -> nil,
	SetVisible: (self: Hotkey__DARKLUA_TYPE_aq, visible: boolean) -> nil,
}

type Components__DARKLUA_TYPE_ar = {
	Window: (self: any, properties: WindowProperties__DARKLUA_TYPE_x?) -> Window__DARKLUA_TYPE_y,
	Section: (self: any, properties: SectionProperties__DARKLUA_TYPE_z?) -> Section__DARKLUA_TYPE_A,
	Tab: (self: any, properties: TabProperties__DARKLUA_TYPE_B?) -> Tab__DARKLUA_TYPE_C,
	Page: (self: any, properties: PageProperties__DARKLUA_TYPE_N?) -> Page__DARKLUA_TYPE_O,
	Form: (self: any, properties: FormProperties__DARKLUA_TYPE_D?) -> Form__DARKLUA_TYPE_E,
	Row: (self: any, properties: RowProperties__DARKLUA_TYPE_F?) -> Row__DARKLUA_TYPE_G,
	VStack: (self: any, properties: StackProperties__DARKLUA_TYPE_H?) -> Stack__DARKLUA_TYPE_I,
	HStack: (self: any, properties: StackProperties__DARKLUA_TYPE_H?) -> Stack__DARKLUA_TYPE_I,
	TitleStack: (self: any, properties: TitleStackProperties__DARKLUA_TYPE_J?) -> TitleStack__DARKLUA_TYPE_K,
	PageSection: (self: any, properties: PageSectionProperties__DARKLUA_TYPE_L?) -> PageSection__DARKLUA_TYPE_M,
	Label: (self: any, properties: LabelProperties__DARKLUA_TYPE_P) -> Label__DARKLUA_TYPE_Q,
	Symbol: (self: any, properties: SymbolProperties__DARKLUA_TYPE_R) -> Symbol__DARKLUA_TYPE_S,
	Toggle: (self: any, properties: ToggleProperties__DARKLUA_TYPE_T) -> Toggle__DARKLUA_TYPE_U,
	TextField: (self: any, properties: TextFieldProperties__DARKLUA_TYPE_V) -> TextField__DARKLUA_TYPE_W,
	KeybindField: (self: any, properties: KeybindFieldProperties__DARKLUA_TYPE_X) -> KeybindField__DARKLUA_TYPE_Y,
	Slider: (self: any, properties: SliderProperties__DARKLUA_TYPE_Z) -> Slider__DARKLUA_TYPE__,
	Button: (self: any, properties: ButtonProperties__DARKLUA_TYPE_0) -> Button__DARKLUA_TYPE_1,
	Stepper: (self: any, properties: StepperProperties__DARKLUA_TYPE_2) -> Stepper__DARKLUA_TYPE_3,
	RadioButtonGroup: (self: any, properties: RadioButtonGroupProperties__DARKLUA_TYPE_4) -> RadioButtonGroup__DARKLUA_TYPE_5,
	PopUpButton: (self: any, properties: PopUpButtonProperties__DARKLUA_TYPE_8) -> PopUpButton__DARKLUA_TYPE_9,
	PullDownButton: (self: any, properties: PullDownButtonProperties__DARKLUA_TYPE_aa) -> PullDownButton__DARKLUA_TYPE_ab,
	Notification: (self: any, properties: NotificationProperties__DARKLUA_TYPE_ac) -> Notification__DARKLUA_TYPE_ad,
	ImageSurface: (self: any, properties: ImageSurfaceProperties__DARKLUA_TYPE_ae) -> ImageSurface__DARKLUA_TYPE_af,
	ColorPicker: (self: any, properties: any) -> any,
	PieChart: (self: any, properties: PieChartProperties__DARKLUA_TYPE_ag) -> PieChart__DARKLUA_TYPE_ah,
	LineChart: (self: any, properties: LineChartProperties__DARKLUA_TYPE_ai) -> LineChart__DARKLUA_TYPE_aj,
	BarChart: (self: any, properties: BarChartProperties__DARKLUA_TYPE_ak) -> BarChart__DARKLUA_TYPE_al,
	ShortcutBadge: (self: any, properties: any) -> ShortcutBadge__DARKLUA_TYPE_an,
	Hotkey: (self: any, properties: any) -> Hotkey__DARKLUA_TYPE_aq,
}

--// Types
type DropdownMenuStructureConfig__DARKLUA_TYPE_as = {
	Name: string?,
}

--// Types
type DropdownMenuConfig__DARKLUA_TYPE_at = {
	Name: string?,
	Anchor: any?,
	AnchorMode: string?,
	Gap: number?,
...
utility.CreateTag = function(create: any, text: string, color: any, textColor: Color3?): any
	...
	elseif typeof(color) == "ColorSequence" then
		...
		create("UIGradient")({
			Name = "UIGradient",
			Color = color,
			Parent = tagFrame.__instance,
		})
	elseif typeof(color) == "table" then
		local keypoints = {}
		if #color >= 2 then
			for i, c in ipairs(color) do
				table.insert(keypoints, ColorSequenceKeypoint.new((i - 1) / (#color - 1), c))
			end
			tagFrame.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			create("UIGradient")({
				Name = "UIGradient",
		...
		elseif #color == 1 then
			tagFrame.BackgroundColor3 = color[1]
		end
	else
		tagFrame.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
		create("UIGradient")({
			...
			Color = ColorSequence.new({
				...
				ColorSequenceKeypoint.new(1, Color3.fromHex("#0056B3")),
			}),
			Parent = tagFrame.__instance,
		})
	end
...
function creator.CreateTag(create: any, text: string, color: any, textColor: Color3?): any
	local tagFrame = create("Frame")({
		Name = "Tag",
		AutomaticSize = Enum.AutomaticSize.XY,
		BackgroundTransparency = 0,
...
end function __DIST.e():typeof(__modImpl())local v=__DIST.cache.e if not v then v={c=__modImpl()}__DIST.cache.e=v end return v.c end end do local function __modImpl()--// Imports
...
return function(self)
	...
	structures.Title = structures.TitleStack:FindFirstChild("Title", true) :: TextLabel
	structures.Subtitle = structures.TitleStack:FindFirstChild("Subtitle", true) :: TextLabel
...
end function __DIST.k():typeof(__modImpl())local v=__DIST.cache.k if not v then v={c=__modImpl()}__DIST.cache.k=v end return v.c end end do local function __modImpl()
...
return function(self, properties: StackProperties__DARKLUA_TYPE_H): Stack__DARKLUA_TYPE_I	--// Imports
...
return function(self, properties: TextFieldProperties__DARKLUA_TYPE_V): TextField__DARKLUA_TYPE_W	--// Imports
	
local binder = __DIST.c()

	--// Variables
	local structures = __DIST.j()(self)
...
return function(self, properties: ButtonProperties__DARKLUA_TYPE_0): Button__DARKLUA_TYPE_1	--// Imports
...
local function formatKey(key: any): string
	if typeof(key) == "EnumItem" then
		return shortNames[key] or key.Name
...
return function(self, properties: any)
	...
	--// Variables
	local parent = properties.Parent or self.__container or self.__instance or self
	local structures = {}
	...
	local label = structures.Body:FindFirstChild("Label")
	local stroke = structures.Body:FindFirstChild("UIStroke")
	...
	local bindings = {
		Key = function(value)
			...
			if not listening then
				label.Text = formatKey(value)
			end
		end,
	}

	object = binder.Wrap(properties, bindings, structures.Body)
	object.Type = "ShortcutBadge"
	object.Structures = structures
	object.Theme = self.Theme
	...
	local function stopListening(newKey)
		...
		if newKey then
			object.Key = newKey
			if properties.Changed then
				task.spawn(properties.Changed, newKey)
			end
			if properties.ValueChanged then
				task.spawn(properties.ValueChanged, object, newKey)
			end
		else
			label.Text = formatKey(properties.Key)
		end
	end
	...
	structures.Body.MouseButton1Click:Connect(function()
		...
		inputConnection = userInputService.InputBegan:Connect(function(input, gameProcessed)
			-- Avoid capturing keybind events if the user is typing in a text field
...
return function(self, properties: any)
	...
	local binder = __DIST.c()
	local services = __DIST.e()
	local createShortcutBadge = __DIST.q()
	...
	-- Resolve top ScreenGui to separate HotkeyWidget from Window visibility
	local parent = properties.Parent or self.__container or self.__instance or self
	local topScreenGui = nil
	if parent then
		if typeof(parent) == "Instance" and parent:IsA("ScreenGui") then
			topScreenGui = parent
		elseif typeof(parent) == "Instance" then
			topScreenGui = parent:FindFirstAncestorOfClass("ScreenGui")
		end
	end
	if not topScreenGui and self and typeof(self) == "table" then
		if self.Structures and self.Structures.WindowPill then
			topScreenGui = self.Structures.WindowPill.Parent
		elseif self.__instance and self.__instance:IsA("ScreenGui") then
			topScreenGui = self.__instance
		end
	end
	parent = topScreenGui or parent

	--// UI Container
	structures.Body = create("Frame")({
		Name = "HotkeyWidget",
		AnchorPoint = Vector2.new(0, 0.5),
		Position = properties.Position or UDim2.new(0, 20, 0.5, 0),
		Size = properties.Size or UDim2.fromOffset(230, 0),
		...
		create("Frame")({
			...
			create("TextLabel")({
				...
				BackgroundTransparency = 1,
				FontFace = Font.new("rbxassetid://12187365364", Enum.FontWeight.Bold),
				Text = properties.Title or "Hotkeys",
	...
	local listFrame = structures.Body:FindFirstChild("List")
	local headerFrame = structures.Body:FindFirstChild("Header")
	...
	--// Global Key Listener for Triggering Actions
		...
		for _, entry in pairs(entries) do
			if entry.Key == input.KeyCode then
				if entry.Callback then
					task.spawn(entry.Callback, input.KeyCode)
				end
			end
		end
	end)
	...
	function widget:AddHotkey(id: string, name: string, key: Enum.KeyCode | string, prefix: string?, callback: ((Enum.KeyCode) -> ())?, options: any?)
		if entries[id] then
			self:UpdateHotkey(id, key)
			return entries[id]
		end

		prefix = prefix or "Toggle"

		if type(callback) == "table" and not options then
			options = callback
			callback = options.Callback or options.ValueChanged
		end
		options = options or {}
		...
		-- Right side key badge
		local badge = createShortcutBadge(self, {
			Key = key,
			Parent = row.__instance,
			Changed = function(newKey)
				...
				if entry then
					...
					if entry.KeybindField then
						entry.KeybindField.Value = newKey
					end
				end
			end,
		})

		badge.Structures.Body.AnchorPoint = Vector2.new(1, 0.5)
		badge.Structures.Body.Position = UDim2.new(1, 0, 0.5, 0)
		...
		local entry = {
			...
			Badge = badge,
			Callback = callback,
			KeybindField = options.KeybindField,
		}
	...
	function widget:RemoveHotkey(id: string)
		local entry = entries[id]
		if entry then
			if entry.Row and entry.Row.__instance then
				entry.Row.__instance:Destroy()
			end
			entries[id] = nil
		end
	end

	function widget:UpdateHotkey(id: string, newKey: Enum.KeyCode | string)
		local entry = entries[id]
		if entry then
			entry.Key = newKey
			if entry.Badge then
				entry.Badge.Key = newKey
			end
			if entry.KeybindField then
				entry.KeybindField.Value = newKey
			end
	...
	function widget:SetVisible(visible: boolean)
		structures.Body.Visible = visible
	end
	...
	object.AddHotkey = function(_, ...) return widget:AddHotkey(...) end
	object.RemoveHotkey = function(_, ...) return widget:RemoveHotkey(...) end
	object.UpdateHotkey = function(_, ...) return widget:UpdateHotkey(...) end
	object.SetVisible = function(_, ...) return widget:SetVisible(...) end
...
return function(self, properties)
    ...
    local contextKeys = {
        Exit = {
			ImageColor3 = function()
				return properties.CanExit and self.Theme.Controls.Exit[1].Value
					or self.Theme.Controls.WindowControlDisabled[1].Value
			end,
			ImageTransparency = function()
				return properties.CanExit and self.Theme.Controls.Exit[2].Value
					or self.Theme.Controls.WindowControlDisabled[2].Value
			end,
		},
        
        Minimize = {
			ImageColor3 = function()
				return properties.CanMinimize and self.Theme.Controls.Minimize[1].Value
					or self.Theme.Controls.WindowControlDisabled[1].Value
			end,
			ImageTransparency = function()
				return properties.CanMinimize and self.Theme.Controls.Minimize[2].Value
					or self.Theme.Controls.WindowControlDisabled[2].Value
			end,
		},
        ...
        Zoom = {
			ImageColor3 = function()
				return properties.CanZoom and self.Theme.Controls.Zoom[1].Value
					or self.Theme.Controls.WindowControlDisabled[1].Value
			end,
			ImageTransparency = function()
				return properties.CanZoom and self.Theme.Controls.Zoom[2].Value
					or self.Theme.Controls.WindowControlDisabled[2].Value
			end,
		}
    }
	...
	structures.Exit = create("ImageButton")({
		Name = "Exit",
		AutoButtonColor = false,
		BackgroundColor3 = Color3.fromRGB(255, 255, 255),
		BackgroundTransparency = 1,
		...
		__contextKeys = contextKeys.Exit,
	...
	structures.Minimize = create("ImageButton")({
		Name = "Minimize",
		AutoButtonColor = false,
		BackgroundColor3 = Color3.fromRGB(255, 255, 255),
		BackgroundTransparency = 1,
		...
		__contextKeys = contextKeys.Minimize,
	...
	structures.Zoom = create("ImageButton")({
		Name = "Zoom",
		AutoButtonColor = false,
		BackgroundColor3 = Color3.fromRGB(255, 255, 255),
		BackgroundTransparency = 1,
		...
		__contextKeys = contextKeys.Zoom,
    ...
    return structures, contextKeys
end
end function __DIST.s():typeof(__modImpl())local v=__DIST.cache.s if not v then v={c=__modImpl()}__DIST.cache.s=v end return v.c end end do local function __modImpl()-- We uh
-- We dont talk about this..


local types = __DIST.b()

return function(self, properties: WindowProperties__DARKLUA_TYPE_x): Window__DARKLUA_TYPE_y	--// Imports
	
local effects = __DIST.i()
	local services = __DIST.e()
	local creator = __DIST.d()
	local binder = __DIST.c()
	local utility = __DIST.a()

	local titleBar, addToHistory = __DIST.k()(self)
	local resizeHandler = __DIST.l()

	local symbols = __DIST.g()
	local createVStack = __DIST.m()
	local createHStack = __DIST.n()
	local createTextField = __DIST.o()
	local createButton = __DIST.p()
	local createHotkey = __DIST.r()
	...
	local hasKeySystem = properties.KeySystem ~= nil
	local keySystemConfig = properties.KeySystem
	local ksOriginalTitle = properties.Title or "Title"
	local ksOriginalSubtitle = properties.Subtitle or ""
	local ksOriginalSize = properties.Size or UDim2.fromOffset(850, 530)
	local ksOriginalSearching = properties.Searching ~= false
	local ksOriginalResizable = properties.Resizable ~= false
	local ksOriginalCanMinimize = properties.CanMinimize ~= false
	local ksOriginalCanZoom = properties.CanZoom ~= false

	if hasKeySystem then
		properties.Title = "Key Verification"
		properties.Subtitle = "Enter your key to unlock the script"
		properties.Size = UDim2.fromOffset(360, 160)
	...
	properties.CanExit = properties.CanExit ~= false
	properties.CanMinimize = properties.CanMinimize ~= false
	properties.CanZoom = properties.CanZoom ~= false
	properties.Resizable = properties.Resizable ~= false
	...
	local windowControls, windowControlsCKeys = __DIST.s()(self, properties)
	...
	structures.WindowControls = windowControls
	if hasKeySystem then
		structures.WindowControls.Body.Parent = structures.Titlebar.Leading
		structures.WindowControls.Body.LayoutOrder = 0
	else
		structures.WindowControls.Body.Parent = structures.Toolbar
	end
	...
	local bindings = {
		Title = function(value: string)
			local container = structures.Titlebar.Title.Parent
			container.Visible = value and true or false
		...
		Subtitle = function(value: string)
			local container = structures.Titlebar.Subtitle.Parent
			container.Visible = value and true or false
		...
		TitleTag = function(value: string?)
			local container = structures.Titlebar.Title.Parent
			local existingTag = container:FindFirstChild("Tag")
			if existingTag then
				existingTag:Destroy()
			end
			if value and value ~= "" then
				local tag = utility.CreateTag(create, value, properties.TitleTagColor, properties.TitleTagTextColor)
				tag.Parent = container
			end
		end,
		SubtitleTag = function(value: string?)
			local container = structures.Titlebar.Subtitle.Parent
			local existingTag = container:FindFirstChild("Tag")
			if existingTag then
				existingTag:Destroy()
			...
			if value and value ~= "" then
				local tag = utility.CreateTag(create, value, properties.SubtitleTagColor, properties.SubtitleTagTextColor)
				tag.Parent = container
			end
		end,
		TitleTagColor = function(value: any)
			properties.TitleTagColor = value
			local container = structures.Titlebar.Title.Parent
			local existingTag = container:FindFirstChild("Tag")
			if existingTag then
				local textLabel = existingTag:FindFirstChild("Label")
				local text = textLabel and textLabel.Text or ""
				existingTag:Destroy()
				local tag = utility.CreateTag(create, text, value, properties.TitleTagTextColor)
				tag.Parent = container
			end
		end,
		TitleTagTextColor = function(value: Color3?)
			properties.TitleTagTextColor = value
			local container = structures.Titlebar.Title.Parent
			local existingTag = container:FindFirstChild("Tag")
			if existingTag then
				local textLabel = existingTag:FindFirstChild("Label")
				if textLabel then
					textLabel.TextColor3 = value or Color3.fromRGB(255, 255, 255)
				end
			end
		end,
		SubtitleTagColor = function(value: any)
			properties.SubtitleTagColor = value
			local container = structures.Titlebar.Subtitle.Parent
			local existingTag = container:FindFirstChild("Tag")
			if existingTag then
				local textLabel = existingTag:FindFirstChild("Label")
				local text = textLabel and textLabel.Text or ""
				existingTag:Destroy()
				local tag = utility.CreateTag(create, text, value, properties.SubtitleTagTextColor)
				tag.Parent = container
			end
		end,
		SubtitleTagTextColor = function(value: Color3?)
			properties.SubtitleTagTextColor = value
			local container = structures.Titlebar.Subtitle.Parent
			local existingTag = container:FindFirstChild("Tag")
			if existingTag then
				local textLabel = existingTag:FindFirstChild("Label")
		...
		CanExit = function(value: boolean)
			properties.CanExit = value

			structures.WindowControls.Exit.ImageColor3 = windowControlsCKeys.Exit.ImageColor3()
			structures.WindowControls.Exit.ImageTransparency = windowControlsCKeys.Exit.ImageTransparency()

			structures.WindowControls.Exit.Active = value
		end,
		CanMinimize = function(value: boolean)
			properties.CanMinimize = value

			structures.WindowControls.Minimize.ImageColor3 = windowControlsCKeys.Minimize.ImageColor3()
			structures.WindowControls.Minimize.ImageTransparency = windowControlsCKeys.Minimize.ImageTransparency()

			structures.WindowControls.Minimize.Active = value
		end,
		CanZoom = function(value: boolean)
			properties.CanZoom = value

			structures.WindowControls.Zoom.ImageColor3 = windowControlsCKeys.Zoom.ImageColor3()
			structures.WindowControls.Zoom.ImageTransparency = windowControlsCKeys.Zoom.ImageTransparency()

			structures.WindowControls.Zoom.Active = value
		end,
	}
	...
	-- Initialize HotkeyWidget if requested
	if properties.Hotkey then
		local hotkeyConfig = typeof(properties.Hotkey) == "table" and properties.Hotkey or {}
		object.HotkeyWidget = createHotkey(object, hotkeyConfig)
	end

	object.AddHotkey = function(selfWindow, id, name, key, prefix, callback, options)
		if selfWindow.HotkeyWidget then
			return selfWindow.HotkeyWidget:AddHotkey(id, name, key, prefix, callback, options)
		else
			warn("HotkeyWidget is not initialized on this Window (enable it by setting Hotkey = true)")
			return nil
		end
	end
	...
	local hiddenFolder
	if hasKeySystem then
		hiddenFolder = create("Folder")({
			Name = "HiddenPages",
		}).__instance
		object.__container = hiddenFolder
	else
		object.__container = structures.Content
	end
	object.Verified = not hasKeySystem
	...
	do -- Window controls
		local wcBody = structures.WindowControls.Body
		local exit = wcBody:FindFirstChild("Exit") :: ImageButton
		local minimize = wcBody:FindFirstChild("Minimize") :: ImageButton
		local zoom = wcBody:FindFirstChild("Zoom") :: ImageButton

		local function rollOver()
			exit:FindFirstChild("Icon").Visible = properties.CanExit
					and wcBody.GuiState ~= Enum.GuiState.Hover
				or false
			minimize:FindFirstChild("Icon").Visible = properties.CanMinimize
					and wcBody.GuiState ~= Enum.GuiState.Hover
				or false
			zoom:FindFirstChild("Icon").Visible = properties.CanZoom
					and wcBody.GuiState ~= Enum.GuiState.Hover
				or false
		end

		zoom.MouseButton1Click:Connect(function()
			if not properties.CanZoom then
				return
			end
		...
		minimize.MouseButton1Click:Connect(function()
			if not properties.CanMinimize then
				return
			end
		...
		exit.MouseButton1Click:Connect(function()
			if not properties.CanExit then
				return
			end
		...
		wcBody.MouseEnter:Connect(rollOver)
		wcBody.MouseLeave:Connect(rollOver)
	end
	...
	if hasKeySystem then
		-- Apply layout modifications for Key Verification mode
		structures.SidebarMargins.Visible = false
		structures.Separator.Visible = false
		structures.ContentBody.Size = UDim2.fromScale(1, 1)

		structures.Titlebar.NavigationButtons.Visible = false

		structures.Titlebar.SidebarButton.Visible = true
		structures.Titlebar.SidebarButton.Image = symbols.key
		structures.Titlebar.SidebarButton.Active = false
		structures.Titlebar.SidebarButton.Interactable = false

		structures.CornerClip.Visible = false
		structures.Titlebar.CornerClipLeft.Visible = false

		-- Create the Key System UI
		local mainStack = createVStack(object, {
			Padding = UDim.new(0, 12),
			HorizontalAlignment = Enum.HorizontalAlignment.Center,
			VerticalAlignment = Enum.VerticalAlignment.Center,
		})

		-- Parent directly to actual visible Content frame
		mainStack.Structures.Body.Parent = structures.Content

		-- Adjust mainStack Body to fill Content completely
		mainStack.Structures.Body.AutomaticSize = Enum.AutomaticSize.None
		mainStack.Structures.Body.Size = UDim2.fromScale(1, 1)

		-- (1) Upper part: Key Input Field
		local keyInput = createTextField(mainStack, {
			Value = "",
			Placeholder = "Enter your key here...",
		})

		keyInput.Structures.Body.AutomaticSize = Enum.AutomaticSize.None
		keyInput.Structures.Body.Size = UDim2.new(0.9, 0, 0, 32)
		keyInput.Structures.Field.AutomaticSize = Enum.AutomaticSize.None
		keyInput.Structures.Field.Size = UDim2.new(1, 0, 1, 0)
		keyInput.Structures.Field.TextXAlignment = Enum.TextXAlignment.Center
		keyInput.Structures.Field.PlaceholderColor3 = Color3.fromRGB(120, 120, 125)

		-- Prevent AutomaticSize change on focus/typing to avoid UI shaking
		keyInput.Structures.Body:GetPropertyChangedSignal("AutomaticSize"):Connect(function()
			if keyInput.Structures.Body.AutomaticSize ~= Enum.AutomaticSize.None then
				keyInput.Structures.Body.AutomaticSize = Enum.AutomaticSize.None
				keyInput.Structures.Body.Size = UDim2.new(0.9, 0, 0, 32)
			end
		end)

		-- (2) Lower part: HStack for buttons
		local buttonStack = createHStack(mainStack, {
			Padding = UDim.new(0, 10),
			HorizontalAlignment = Enum.HorizontalAlignment.Center,
			VerticalAlignment = Enum.VerticalAlignment.Center,
		})

		-- (3) Copy Key Link Button
		local copyBtn = createButton(buttonStack, {
			Label = "Copy Key Link",
			State = "Secondary",
		})
		copyBtn.Structures.Body.AutomaticSize = Enum.AutomaticSize.None
		copyBtn.Structures.Body.Size = UDim2.new(0, 140, 0, 30)
		copyBtn.Structures.Label.Size = UDim2.fromScale(1, 1)
		copyBtn.Structures.Label.AutomaticSize = Enum.AutomaticSize.None

		-- (4) Verify Key Button
		local verifyBtn = createButton(buttonStack, {
			Label = "Verify Key",
			State = "Primary",
		})
		verifyBtn.Structures.Body.AutomaticSize = Enum.AutomaticSize.None
		verifyBtn.Structures.Body.Size = UDim2.new(0, 140, 0, 30)
		verifyBtn.Structures.Label.Size = UDim2.fromScale(1, 1)
		verifyBtn.Structures.Label.AutomaticSize = Enum.AutomaticSize.None

		-- Define SDK helpers
		local Junkie
		local function getJunkieSDK()
			if not Junkie then
				local success, sdk = pcall(function()
					return loadstring(game:HttpGet("https://jnkie.com/sdk/library.lua"))()
				end)
				if success and sdk then
					Junkie = sdk
					Junkie.service = keySystemConfig.Service
					Junkie.identifier = keySystemConfig.Identifier
					Junkie.provider = keySystemConfig.Provider or "Mixed"
				else
					warn("Failed to load JnKie SDK from URL.")
				end
			end
			return Junkie
		end
		...
		copyBtn.Structures.Body.MouseButton1Click:Connect(function()
			local sdk = getJunkieSDK()
			if not sdk then
				self:Notification({
					Title = "Connection Error",
					Subtitle = "JnKie SDK를 로드할 수 없습니다. 인터넷 연결을 확인하세요.",
					App = "Key System",
					Duration = 4,
				})
				return
			...
			local link, err = sdk.get_key_link()
			if link then
				...
				self:Notification({
					Title = "Link Copied",
					Subtitle = "키 생성 페이지 주소가 클립보드에 복사되었습니다!",
					App = "Key System",
					AppIcon = symbols.checkmark,
					Duration = 3,
				})
			else
				local errorMsg = "링크를 불러오지 못했습니다."
				if err == "RATE_LIMITTED" then
					errorMsg = "요청이 너무 빠릅니다! 5분 뒤에 다시 시도해주세요."
				end

				self:Notification({
					Title = "Get Link Failed",
					Subtitle = errorMsg,
					App = "Key System",
					Duration = 4,
				})
		...
		verifyBtn.Structures.Body.MouseButton1Click:Connect(function()
			local userInput = keyInput.Structures.Field.Text
			if #userInput == 0 then
				self:Notification({
					Title = "Input Required",
					Subtitle = "검증할 키를 입력창에 기입해주세요.",
					App = "Key System",
					Duration = 3,
				})
				return
			...
			self:Notification({
				Title = "Verifying...",
				Subtitle = "JnKie 서버에 키를 검증하는 중입니다.",
				App = "Key System",
				Duration = 2,
			})
			...
			local validation = sdk.check_key(userInput)
			local isValid = false
			local errorMsg = "Unknown key error"

			if type(validation) == "table" then
				if validation.success ~= nil then
					isValid = validation.success
				elseif validation.valid ~= nil then
					isValid = validation.valid
				end
				errorMsg = validation.error or errorMsg
			end
			...
			if isValid then
				...
				self:Notification({
					...
					Subtitle = "인증이 완료되었습니다! 스크립트를 로드합니다.",
					App = "Key System",
					AppIcon = symbols.checkmark,
					Duration = 3,
				})
				...
				task.delay(1.2, function()
					-- Destroy Key verification card elements
					mainStack.Structures.Body:Destroy()

					-- Restore Window layouts
					structures.SidebarMargins.Visible = true
					structures.Separator.Visible = true
					structures.Titlebar.NavigationButtons.Visible = true
					structures.CornerClip.Visible = true
					structures.Titlebar.CornerClipLeft.Visible = true

					-- Restore window controls parent
					structures.WindowControls.Body.Parent = structures.Toolbar
					structures.WindowControls.Body.LayoutOrder = nil

					-- Restore window configurations & sizes via bindings
					bindings.CanMinimize(ksOriginalCanMinimize)
					bindings.CanZoom(ksOriginalCanZoom)
					bindings.CanExit(true)
					bindings.Searching(ksOriginalSearching)
					bindings.Resizable(ksOriginalResizable)

					-- Restore Titlebar Sidebar Button state
					structures.Titlebar.SidebarButton.Image = "rbxassetid://74380920233260"
					structures.Titlebar.SidebarButton.Active = true
					structures.Titlebar.SidebarButton.Interactable = true

					-- Restore original title and subtitle
					bindings.Title(ksOriginalTitle)
					bindings.Subtitle(ksOriginalSubtitle)

					-- Re-enable resizing if it was resizable
					if resizeClient then
						resizeClient.SetEnabled(ksOriginalResizable)
					end

					-- Restore Content body size
					structures.ContentBody.Size = UDim2.new(1, -201, 1, 0)
					structures.SidebarMargins.Size = UDim2.new(0, 200, 1, 0)
					structures.SidebarMargins:FindFirstChild("UIPadding").PaddingLeft = UDim.new(0, 0)

					-- Restore window container and parent selected tabs
					object.Verified = true
					object.__container = structures.Content
					if object.Tabs then
						for _, tab in ipairs(object.Tabs) do
							if tab.Selected and tab.Structures and tab.Structures.Page then
								tab.Structures.Page.Parent = structures.Content
								tab.Structures.Page.Position = UDim2.new(0, 0, 0, 0)
								tab.Structures.Page.Visible = true
							end
						end
					end
					...
					-- Resize Window to original size via tween if not maximized
					if not properties.Maximized then
						local tweenInfo = TweenInfo.new(0.5, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out)
						tweenService:Create(structures.Body.__instance, tweenInfo, {
							Size = ksOriginalSize,
						}):Play()
					else
						originalSize = ksOriginalSize
					end

					-- Execute callback
					if keySystemConfig.OnVerified then
						task.spawn(keySystemConfig.OnVerified)
					end
				end)
			else
				local readableError = "올바르지 않은 키입니다."
				if errorMsg == "KEY_INVALID" then
					readableError = "시스템에 등록되지 않았거나 올바르지 않은 키입니다."
				elseif errorMsg == "KEY_EXPIRED" then
					readableError = "만료된 키입니다. 새 키를 발급받아주세요."
				elseif errorMsg == "HWID_BANNED" then
					readableError = "차단된 기기(HWID)입니다. 관리자에게 문의하세요."
				elseif errorMsg == "KEY_INVALIDATED" then
					readableError = "관리자에 의해 수동으로 비활성화된 키입니다."
				elseif errorMsg == "ALREADY_USED" then
					readableError = "이미 다른 곳에서 사용된 일회용 키입니다."
				elseif errorMsg == "HWID_MISMATCH" then
					readableError = "기기 변경 한도를 초과했습니다. (HWID 불일치)"
				elseif errorMsg == "SERVICE_NOT_FOUND" then
					readableError = "연결된 서비스를 찾을 수 없습니다 (서비스 설정 확인 필요)."
				elseif errorMsg == "SERVICE_MISMATCH" then
					readableError = "해당 키는 다른 스크립트용 키입니다."
				elseif errorMsg == "PREMIUM_REQUIRED" then
					readableError = "이 서비스를 이용하기 위해선 프리미엄 키가 필요합니다."
				end

				self:Notification({
					Title = "Verification Failed",
					Subtitle = readableError,
					App = "Key System",
					Duration = 4,
				})
			end
...
return function(self, properties: SectionProperties__DARKLUA_TYPE_z): Section__DARKLUA_TYPE_A	--// Imports
...
return function(self, properties: PageProperties__DARKLUA_TYPE_N)
	--// Imports
	local creator = __DIST.d()
	local binder = __DIST.c()
...
local function unwrap(object)
	if typeof(object) == "table" and object.__instance then
		return object.__instance
	end
	return object
end

return function(self, properties: TabProperties__DARKLUA_TYPE_B): Tab__DARKLUA_TYPE_C	--// Imports
...
local creator = __DIST.d()
	...
	object = binder.Wrap(properties, {
		...
		Selected = function(selected: boolean)
			if selected then
				for _, tab: Tab__DARKLUA_TYPE_C in pairs(window.Tabs) do
					if tab.__container == object.__container then
						continue
					end
			...
			-- Tween highlight transparency and text/symbol color
			local targetTransparency = selected and self.Theme.Controls.SelectionFocused[2].Value or 1
			local targetTitleColor = selected and self.Theme.Text.SelectionPrimary[1].Value or self.Theme.Text.Primary[1].Value
			local targetTitleTransparency = selected and self.Theme.Text.SelectionPrimary[2].Value or self.Theme.Text.Primary[2].Value
			local targetSymbolColor = selected and self.Theme.Text.SelectionPrimary[1].Value or self.Theme.Controls.Selection[1].Value
			local targetSymbolTransparency = selected and self.Theme.Text.SelectionPrimary[2].Value or self.Theme.Controls.Selection[2].Value

			local tweenInfo = TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out)
			tweenService:Create(unwrap(structures.Body), tweenInfo, { BackgroundTransparency = targetTransparency }):Play()
			tweenService:Create(unwrap(structures.Title), tweenInfo, { TextColor3 = targetTitleColor, TextTransparency = targetTitleTransparency }):Play()
			tweenService:Create(unwrap(structures.Symbol), tweenInfo, { ImageColor3 = targetSymbolColor, ImageTransparency = targetSymbolTransparency }):Play()

			if selected then
				structures.Page.Parent = window and window.__container or nil
				structures.Page.Position = UDim2.new(0, 0, 0, 15)
				structures.Page.Visible = not (window and window.Verified == false)
				tweenService:Create(unwrap(structures.Page), TweenInfo.new(0.35, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {
	...
	object.Navigate = function(self, targetPage: Page__DARKLUA_TYPE_O)
		...
		if object.Selected and window and window.__container then
			...
			newPageStructure.Position = UDim2.new(0, 0, 0, 15)
			newPageStructure.Visible = not (window and window.Verified == false)
			tweenService:Create(unwrap(newPageStructure), TweenInfo.new(0.35, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {
				Position = UDim2.new(0, 0, 0, 0),
			}):Play()
		end
	...
	object.Theme = self.Theme
	object.Structures = structures
	object.__container = unwrap(structures.Page)
	object.__window = window
...
return function(self)
	...
	--// Initialize
	structures.Title = structures.Body:FindFirstChild("Title", true) :: TextLabel
	structures.Subtitle = structures.Body:FindFirstChild("Subtitle", true) :: TextLabel
	structures.Padding = structures.Body:FindFirstChild("UIPadding") :: UIPadding
...
return function(self, properties: PageSectionProperties__DARKLUA_TYPE_L): PageSection__DARKLUA_TYPE_M	--// Imports
	
local creator = __DIST.d()
	local binder = __DIST.c()
	local utility = __DIST.a()

	local titleStack = __DIST.x()
	...
	local object = binder.Wrap(properties, {
		Title = function(value: string?)
			local container = structures.Title.Parent
			local hasText = value ~= nil and value ~= ""
			container.Visible = hasText
			if hasText then
				structures.Title.Text = value
			end
		end,
		Subtitle = function(value: string?)
			local container = structures.Subtitle.Parent
			local hasText = value ~= nil and value ~= ""
			container.Visible = hasText
			if hasText then
...
return function(self, properties: Frame__DARKLUA_TYPE_g): Form__DARKLUA_TYPE_E	--// Imports
...
return function(self, properties: RowProperties__DARKLUA_TYPE_F): Row__DARKLUA_TYPE_G	--// Imports
...
return function(self, properties: TitleStackProperties__DARKLUA_TYPE_J): TitleStack__DARKLUA_TYPE_K	--// Imports
...
return function(self, properties: LabelProperties__DARKLUA_TYPE_P): Label__DARKLUA_TYPE_Q	--// Imports
...
return function(self, properties: SymbolProperties__DARKLUA_TYPE_R): Symbol__DARKLUA_TYPE_S	--// Imports
...
return function(self, properties: ToggleProperties__DARKLUA_TYPE_T): Row__DARKLUA_TYPE_G	--// Imports
...
local function findWindow(ctx)
	if typeof(ctx) ~= "table" then return nil end
	if ctx.Type == "Window" then
		return ctx
	end
	if ctx.__window then
		return findWindow(ctx.__window)
	end
	return nil
end

local function findRowTitle(body)
	local current = body
	while current do
		local searchIndex = current:GetAttribute("SearchIndex")
		if searchIndex and searchIndex ~= "" then
			return searchIndex
		end
		
		-- Check LeftAccessory of the current container if it looks like a Row
		local left = current:FindFirstChild("LeftAccessory")
		if left then
			local titleStack = left:FindFirstChild("TitleStack")
			if titleStack then
				local titleLabel = titleStack:FindFirstChild("Title")
				if titleLabel and titleLabel:IsA("TextLabel") then
					return titleLabel.Text
				end
			end
			local label = left:FindFirstChild("Label") or left:FindFirstChildOfClass("TextLabel")
			if label then
				return label.Text
			end
		end
...
return function(self, properties: KeybindFieldProperties__DARKLUA_TYPE_X): KeybindFieldProperties__DARKLUA_TYPE_X	--// Imports
...
local binder = __DIST.c()
	...
	object = binder.Wrap(properties, {
		...
		Value = function(value: Enum.KeyCode)
			structures.Field.Text = formatKey(value)
			...
			-- Sync value to HotkeyWidget
			if window and window.HotkeyWidget and hotkeyEntry and hotkeyId then
				if hotkeyEntry.Key ~= value then
					window.HotkeyWidget:UpdateHotkey(hotkeyId, value)
				end
			end
		end,
	}, structures.Body)
	...
	-- Handle automatic Hotkey registration if not explicitly disabled
	if properties.Hotkey ~= false and window and window.HotkeyWidget then
		local hotkeyInfo = properties.Hotkey
		local hotkeyName, hotkeyPrefix

		if type(hotkeyInfo) == "table" then
			hotkeyId = hotkeyInfo.Id
			hotkeyName = hotkeyInfo.Name
			hotkeyPrefix = hotkeyInfo.Prefix
		end

		if not hotkeyName then
			local rowTitle = findRowTitle(structures.Body.__instance)
			hotkeyName = rowTitle or properties.Placeholder or "Keybind"
		end

		if not hotkeyId then
			local baseId = properties.Id or ("hotkey_" .. (string.gsub(string.lower(hotkeyName), "[%s%p]+", "_")))
			hotkeyId = baseId
			-- Ensure uniqueness of the hotkey ID in the widget
			if window.HotkeyWidget.Entries[hotkeyId] then
				local counter = 1
				while window.HotkeyWidget.Entries[baseId .. "_" .. tostring(counter)] do
					counter = counter + 1
				end
				hotkeyId = baseId .. "_" .. tostring(counter)
			end
		end

		if not hotkeyPrefix then
			hotkeyPrefix = "Toggle"
		end

		hotkeyEntry = window.HotkeyWidget:AddHotkey(hotkeyId, hotkeyName, properties.Value or Enum.KeyCode.Unknown, hotkeyPrefix, {
			KeybindField = object,
...
return function(self, properties: SliderProperties__DARKLUA_TYPE_Z): Slider__DARKLUA_TYPE__	--// Imports
...
return function(self, properties: StepperProperties__DARKLUA_TYPE_2): Stepper__DARKLUA_TYPE_3	--// Imports
	
local creator = __DIST.d()
	local binder = __DIST.c()

	local textField = __DIST.j()
	--// References
...
return function(self, properties: RadioButtonGroupProperties__DARKLUA_TYPE_4): RadioButtonGroup__DARKLUA_TYPE_5	--// Imports
...
end function __DIST.I():typeof(__modImpl())local v=__DIST.cache.I if not v then v={c=__modImpl()}__DIST.cache.I=v end return v.c end end do local function __modImpl()--// Imports
...
return function(self, config: DropdownMenuStructureConfig__DARKLUA_TYPE_as?)
	--// Variables
	local create = creator.Create
	...
	structures.Container = create("ScreenGui")({
		Name = "Container",
		IgnoreGuiInset = true,
		ResetOnSpawn = false,
		...
		create("CanvasGroup")({
			...
			create("ScrollingFrame")({
				Name = config.Name or "DropdownMenu",
				AutomaticSize = Enum.AutomaticSize.XY,
				BorderColor3 = Color3.fromRGB(0, 0, 0),
				BorderSizePixel = 0,
				AutomaticCanvasSize = Enum.AutomaticSize.Y,
	...
	structures.Body = structures.Container:FindFirstChild("MenuBody") :: CanvasGroup
	structures.Menu = structures.Body:FindFirstChild(config.Name or "DropdownMenu") :: ScrollingFrame

	--// Public Methods
	function structures.Item(name: string?, index: number, showsCheckmark: boolean?): TextButton
		local item = nil
		item = create("TextButton")({
			Name = "Item",
			Size = UDim2.fromScale(1, 0),
			AutoButtonColor = false,
			AutomaticSize = Enum.AutomaticSize.XY,
			...
			__contextKeys = {
				BackgroundTransparency = function()
					...
					return item.GuiState == Enum.GuiState.Hover and self.Theme.Controls.SelectionFocused[2].Value or 1
				end,
			},
...
local createStructure = __DIST.J()
local services = __DIST.e()
local utility = __DIST.a()
...
--// Public Methods
function DropdownMenu.new(context, componentStructures, config: DropdownMenuConfig__DARKLUA_TYPE_at?)
	config = config or {}
...
return function(self, properties: PopUpButtonProperties__DARKLUA_TYPE_8): PopUpButton__DARKLUA_TYPE_9	--// Imports
	
local creator = __DIST.d()
	local binder = __DIST.c()
	local dropdownMenu = __DIST.K()
...
return function(self, properties: PullDownButtonProperties__DARKLUA_TYPE_aa): PullDownButton__DARKLUA_TYPE_ab	--// Imports
...
return function(self: any, properties: NotificationProperties__DARKLUA_TYPE_ac, state: { Age: number }, MAX_NOTIFICATIONS: number)
	local creator = __DIST.d()
...
return function(self, properties: NotificationProperties__DARKLUA_TYPE_ac): Notification__DARKLUA_TYPE_ad	
local services = __DIST.e()
	local binder = __DIST.c()
	local notificationList = __DIST.N()
	local ui = __DIST.O()
...
return function(self: any)
	...
	local body = create("Frame")({
		...
		create("Frame")({
			...
			create("UIGradient")({
                ...
                __dynamicKeys = {
                    Color = self.Theme.Controls.ImageSurface.Gradient,
                },
			}),
		}),
	}) :: Frame
    ...
    structures.Surface = body:FindFirstChild("Surface") :: Frame
    structures.Image = structures.Surface and structures.Surface:FindFirstChild("Image") :: ImageLabel
    structures.Gradient = structures.Surface and structures.Surface:FindFirstChild("UIGradient") :: UIGradient
...
return function(self, properties: ImageSurfaceProperties__DARKLUA_TYPE_ae): ImageSurface__DARKLUA_TYPE_af	--// Imports
...
return function(self, properties: any)
	...
	properties = properties or {}
	properties.Value = properties.Value or Color3.fromRGB(255, 255, 255)
	properties.Transparency = properties.Transparency or 0 -- 0 is opaque, 1 is transparent
	...
	if not structures.ColorButton then
		warn("[ColorPicker] ColorButton not found under Body!")
	end

	-- Popover state
	local popoverFrame = nil

	-- Bindings for the widget button
	local object
	local bindings = {
		Value = function(color: Color3)
			currentValue = color
			structures.ColorButton.BackgroundColor3 = color
			if properties.ValueChanged then
				task.spawn(properties.ValueChanged, object, color, currentTransparency)
			end
		end,
		Transparency = function(transparency: number)
			currentTransparency = transparency
			structures.ColorButton.BackgroundTransparency = transparency
			if properties.ValueChanged then
				task.spawn(properties.ValueChanged, object, currentValue, transparency)
			end
		end,
	}
	...
	-- Helper function to check if a point is inside a GuiObject
	local function pointInside(guiObject: GuiObject?, x: number, y: number): boolean
		if not guiObject then
			return false
		end
	...
	local function createInputField(labelText, defaultValue, layoutOrder, parentFrame)
		local fieldFrame = create("Frame")({
			Size = UDim2.new(1, 0, 0, 24),
			BackgroundTransparency = 1,
		...
		return fieldFrame:FindFirstChild("Input") :: TextBox
	end
	...
	local function openPopover()
		...
		local ok, err = xpcall(function()
			...
			local tempColor = currentValue
			local tempTransparency = currentTransparency

			local panel
			local colorWheel
			local selectorDot
			local hexInput, rInput, gInput, bInput, aInput
			local brightnessGradient, brightnessThumb
			local opacityGradient, opacityThumb
			local newColorBar, originalColorBar

			-- 1. Popover Panel Frame 생성 (순수 Instance.new)
			panel = Instance.new("Frame")
			panel.Name = "ColorPickerPanel"
			panel.Size = UDim2.fromOffset(280, 340)
			...
			titleLabel.Text = properties.Title or "Colorpicker"
			titleLabel.TextSize = 15
			titleLabel.TextColor3 = Color3.fromRGB(255, 255, 255)
			titleLabel.TextXAlignment = Enum.TextXAlignment.Center
			titleLabel.FontFace = Font.new("rbxassetid://12187365364")
			titleLabel.LayoutOrder = 1
			titleLabel.Parent = panel

			-- 3. Middle Split (Color Wheel & Inputs Frame)
			local middleSplit = Instance.new("Frame")
			middleSplit.Name = "MiddleSplit"
			middleSplit.Size = UDim2.new(1, 0, 0, 120)
			middleSplit.BackgroundTransparency = 1
			middleSplit.LayoutOrder = 2
			middleSplit.Parent = panel
			...
			middleLayout.Parent = middleSplit

			-- Left Color Wheel (ImageButton)
			colorWheel = Instance.new("ImageButton")
			colorWheel.Name = "ColorWheel"
			colorWheel.Size = UDim2.fromOffset(120, 120)
			colorWheel.BackgroundTransparency = 1
			colorWheel.Image = "rbxthumb://type=Asset&id=111925988136154&w=420&h=420" -- High quality working HSV color wheel (RbxThumb wrapper)
			colorWheel.ImageTransparency = 0
			colorWheel.LayoutOrder = 1
			colorWheel.AutoButtonColor = false
			colorWheel.Parent = middleSplit

			local wheelCorner = Instance.new("UICorner")
			wheelCorner.CornerRadius = UDim.new(0.5, 0)
			wheelCorner.Parent = colorWheel

			-- Selector Dot on Color Wheel
			selectorDot = Instance.new("Frame")
			selectorDot.Name = "SelectorDot"
			selectorDot.Size = UDim2.fromOffset(8, 8)
			selectorDot.AnchorPoint = Vector2.new(0.5, 0.5)
			selectorDot.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			selectorDot.ZIndex = 100002
			selectorDot.Parent = colorWheel

			local dotCorner = Instance.new("UICorner")
			dotCorner.CornerRadius = UDim.new(0.5, 0)
			dotCorner.Parent = selectorDot

			local dotStroke = Instance.new("UIStroke")
			dotStroke.Color = Color3.fromRGB(0, 0, 0)
			dotStroke.Thickness = 1.5
			dotStroke.Parent = selectorDot

			-- Right Inputs Frame
			local inputsFrame = Instance.new("Frame")
			inputsFrame.Name = "InputsFrame"
			inputsFrame.Size = UDim2.new(1, -130, 1, 0)
			inputsFrame.BackgroundTransparency = 1
			inputsFrame.LayoutOrder = 2
			inputsFrame.Parent = middleSplit
			...
			inputsLayout.Padding = UDim.new(0, 2)
			inputsLayout.Parent = inputsFrame

			-- Helper to create pure inputs
			local function createPureInputField(labelText, defaultValue, layoutOrder, parentFrame)
				local fieldFrame = Instance.new("Frame")
				fieldFrame.Size = UDim2.new(1, 0, 0, 22)
				fieldFrame.BackgroundTransparency = 1
				fieldFrame.LayoutOrder = layoutOrder
				fieldFrame.Parent = parentFrame
				...
				input.FontFace = Font.new("rbxassetid://12187365364")
			...
			hexInput = createPureInputField("Hex", colorToHex(tempColor), 1, inputsFrame)
			rInput = createPureInputField("Red", math.floor(tempColor.R * 255), 2, inputsFrame)
			gInput = createPureInputField("Green", math.floor(tempColor.G * 255), 3, inputsFrame)
			bInput = createPureInputField("Blue", math.floor(tempColor.B * 255), 4, inputsFrame)
			aInput = createPureInputField("Alpha", math.floor((1 - tempTransparency) * 100), 5, inputsFrame)

			-- Visual Indicator update dot from color
			local function updateSelectorDotFromColor(color)
				local hue, saturation, _ = color:ToHSV()
				local angle = hue * 2 * math.pi - math.pi / 2
				local rad = saturation * 0.5
				local dotX = 0.5 + rad * math.cos(angle)
				local dotY = 0.5 + rad * math.sin(angle)
				selectorDot.Position = UDim2.fromScale(dotX, dotY)
			end

			-- 4. Brightness Slider
			local brightnessFrame = Instance.new("Frame")
			brightnessFrame.Name = "BrightnessSlider"
			brightnessFrame.Size = UDim2.new(1, 0, 0, 20)
			brightnessFrame.BackgroundTransparency = 1
			brightnessFrame.LayoutOrder = 3
			brightnessFrame.Parent = panel

			local brightnessLayout = Instance.new("UIListLayout")
			brightnessLayout.FillDirection = Enum.FillDirection.Horizontal
			brightnessLayout.VerticalAlignment = Enum.VerticalAlignment.Center
			brightnessLayout.Padding = UDim.new(0, 10)
			brightnessLayout.Parent = brightnessFrame

			local brightnessLabel = Instance.new("TextLabel")
			brightnessLabel.Size = UDim2.new(0, 60, 1, 0)
			brightnessLabel.BackgroundTransparency = 1
			brightnessLabel.Text = "Brightness"
			brightnessLabel.TextSize = 13
			brightnessLabel.TextColor3 = Color3.fromRGB(180, 180, 180)
			brightnessLabel.FontFace = Font.new("rbxassetid://12187365364")
			brightnessLabel.TextXAlignment = Enum.TextXAlignment.Left
			brightnessLabel.Parent = brightnessFrame

			local brightnessTrack = Instance.new("ImageButton")
			brightnessTrack.Name = "Track"
			brightnessTrack.Size = UDim2.new(1, -70, 0, 8)
			brightnessTrack.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			brightnessTrack.AutoButtonColor = false
			brightnessTrack.Parent = brightnessFrame

			local brightnessTrackCorner = Instance.new("UICorner")
			brightnessTrackCorner.CornerRadius = UDim.new(0.5, 0)
			brightnessTrackCorner.Parent = brightnessTrack

			brightnessGradient = Instance.new("UIGradient")
			local h_init, s_init, v_init = tempColor:ToHSV()
			brightnessGradient.Color = ColorSequence.new({
				ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 0, 0)),
				ColorSequenceKeypoint.new(1, Color3.fromHSV(h_init, s_init, 1))
			})
			brightnessGradient.Parent = brightnessTrack

			brightnessThumb = Instance.new("Frame")
			brightnessThumb.Name = "Thumb"
			brightnessThumb.Size = UDim2.fromOffset(12, 12)
			brightnessThumb.AnchorPoint = Vector2.new(0.5, 0.5)
			brightnessThumb.Position = UDim2.new(v_init, 0, 0.5, 0)
			brightnessThumb.BackgroundColor3 = Color3.fromRGB(240, 240, 240)
			brightnessThumb.Parent = brightnessTrack

			local brightnessThumbCorner = Instance.new("UICorner")
			brightnessThumbCorner.CornerRadius = UDim.new(0.5, 0)
			brightnessThumbCorner.Parent = brightnessThumb

			-- 5. Transparency Slider
			local opacityFrame = Instance.new("Frame")
			opacityFrame.Name = "TransparencySlider"
			opacityFrame.Size = UDim2.new(1, 0, 0, 20)
			opacityFrame.BackgroundTransparency = 1
			opacityFrame.LayoutOrder = 4
			opacityFrame.Parent = panel

			local opacityLayout = Instance.new("UIListLayout")
			opacityLayout.FillDirection = Enum.FillDirection.Horizontal
			opacityLayout.VerticalAlignment = Enum.VerticalAlignment.Center
			opacityLayout.Padding = UDim.new(0, 10)
			opacityLayout.Parent = opacityFrame

			local opacityLabel = Instance.new("TextLabel")
			opacityLabel.Size = UDim2.new(0, 60, 1, 0)
			opacityLabel.BackgroundTransparency = 1
			opacityLabel.Text = "Opacity"
			opacityLabel.TextSize = 13
			opacityLabel.TextColor3 = Color3.fromRGB(180, 180, 180)
			opacityLabel.FontFace = Font.new("rbxassetid://12187365364")
			opacityLabel.TextXAlignment = Enum.TextXAlignment.Left
			opacityLabel.Parent = opacityFrame

			local opacityTrackBG = Instance.new("ImageLabel")
			opacityTrackBG.Name = "TrackBG"
			opacityTrackBG.Size = UDim2.new(1, -70, 0, 8)
			opacityTrackBG.BackgroundTransparency = 1
			opacityTrackBG.Image = "rbxassetid://143370504" -- Checkerboard
			opacityTrackBG.ScaleType = Enum.ScaleType.Tile
			opacityTrackBG.TileSize = UDim2.fromOffset(8, 8)
			opacityTrackBG.Parent = opacityFrame

			local opacityTrackBGCorner = Instance.new("UICorner")
			opacityTrackBGCorner.CornerRadius = UDim.new(0.5, 0)
			opacityTrackBGCorner.Parent = opacityTrackBG

			local opacityTrack = Instance.new("ImageButton")
			opacityTrack.Name = "Track"
			opacityTrack.Size = UDim2.fromScale(1, 1)
			opacityTrack.BackgroundTransparency = 0
			opacityTrack.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
			opacityTrack.AutoButtonColor = false
			opacityTrack.Parent = opacityTrackBG

			local opacityTrackCorner = Instance.new("UICorner")
			opacityTrackCorner.CornerRadius = UDim.new(0.5, 0)
			opacityTrackCorner.Parent = opacityTrack

			opacityGradient = Instance.new("UIGradient")
			opacityGradient.Color = ColorSequence.new({
				ColorSequenceKeypoint.new(0, tempColor),
				ColorSequenceKeypoint.new(1, tempColor)
			})
			opacityGradient.Transparency = NumberSequence.new({
				NumberSequenceKeypoint.new(0, 1),
				NumberSequenceKeypoint.new(1, 0)
			})
			opacityGradient.Parent = opacityTrack

			opacityThumb = Instance.new("Frame")
			opacityThumb.Name = "Thumb"
			opacityThumb.Size = UDim2.fromOffset(12, 12)
			opacityThumb.AnchorPoint = Vector2.new(0.5, 0.5)
			opacityThumb.Position = UDim2.new(1 - tempTransparency, 0, 0.5, 0)
			opacityThumb.BackgroundColor3 = Color3.fromRGB(240, 240, 240)
			opacityThumb.Parent = opacityTrack

			local opacityThumbCorner = Instance.new("UICorner")
			opacityThumbCorner.CornerRadius = UDim.new(0.5, 0)
			opacityThumbCorner.Parent = opacityThumb

			-- Update visuals function
			local function updatePopoverVisuals()
				local h, s, v = tempColor:ToHSV()
				newColorBar.BackgroundColor3 = tempColor
				newColorBar.BackgroundTransparency = tempTransparency

				-- Sync brightness slider track color
				brightnessGradient.Color = ColorSequence.new({
					ColorSequenceKeypoint.new(0, Color3.fromRGB(0, 0, 0)),
					ColorSequenceKeypoint.new(1, Color3.fromHSV(h, s, 1))
				})

				-- Sync opacity slider track color
				opacityGradient.Color = ColorSequence.new({
					ColorSequenceKeypoint.new(0, tempColor),
					ColorSequenceKeypoint.new(1, tempColor)
				})
			...
			-- Sync text changes helper
			local function onColorOrTransparencyUpdatedFromTextInput()
				local _, _, v = tempColor:ToHSV()
				brightnessThumb.Position = UDim2.new(v, 0, 0.5, 0)
				opacityThumb.Position = UDim2.new(1 - tempTransparency, 0, 0.5, 0)
				updateSelectorDotFromColor(tempColor)
				updatePopoverVisuals()
			end

			-- Connect text inputs
			local isUpdatingInputs = false
			local function onRGBInputsChanged()
				if isUpdatingInputs then return end
				isUpdatingInputs = true
				local r = tonumber(rInput.Text) or 0
				local g = tonumber(gInput.Text) or 0
				local b = tonumber(bInput.Text) or 0
				local a = tonumber(aInput.Text) or 100
				...
				tempTransparency = 1 - (a / 100)

				hexInput.Text = colorToHex(tempColor)
				onColorOrTransparencyUpdatedFromTextInput()
			...
			hexInput.FocusLost:Connect(function()
				...
				if newC then
					tempColor = newC
					rInput.Text = tostring(math.floor(newC.R * 255))
					gInput.Text = tostring(math.floor(newC.G * 255))
					bInput.Text = tostring(math.floor(newC.B * 255))
					onColorOrTransparencyUpdatedFromTextInput()
				else
					hexInput.Text = colorToHex(tempColor)
				end
			...
			rInput.FocusLost:Connect(onRGBInputsChanged)
			gInput.FocusLost:Connect(onRGBInputsChanged)
			bInput.FocusLost:Connect(onRGBInputsChanged)
			aInput.FocusLost:Connect(onRGBInputsChanged)

			-- Wheel interaction logic
			local isDraggingWheel = false
			local function updateWheel(input)
				local wheelAbsPos = colorWheel.AbsolutePosition
				local wheelAbsSize = colorWheel.AbsoluteSize
				local centerX = wheelAbsPos.X + wheelAbsSize.X / 2
				local centerY = wheelAbsPos.Y + wheelAbsSize.Y / 2
				
				local dx = input.Position.X - centerX
				local dy = input.Position.Y - centerY
				local distance = math.sqrt(dx^2 + dy^2)
				local radius = wheelAbsSize.X / 2
				
				local angle = math.atan2(dy, dx)
				local hue = ((angle + math.pi / 2) / (2 * math.pi)) % 1
				local saturation = math.clamp(distance / radius, 0, 1)
				
				local _, _, value = tempColor:ToHSV()
				tempColor = Color3.fromHSV(hue, saturation, value)
				
				-- Update Selector Dot Position
				local clampedDist = math.clamp(distance, 0, radius)
				local rad = (clampedDist / radius) * 0.5
				local screenAngle = hue * 2 * math.pi - math.pi / 2
				local dotX = 0.5 + rad * math.cos(screenAngle)
				local dotY = 0.5 + rad * math.sin(screenAngle)
				selectorDot.Position = UDim2.fromScale(dotX, dotY)
			...
			local function updateBrightness(input)
				local delta = input.Position.X - brightnessTrack.AbsolutePosition.X
				local percent = math.clamp(delta / brightnessTrack.AbsoluteSize.X, 0, 1)
				brightnessThumb.Position = UDim2.new(percent, 0, 0.5, 0)
				
				local h, s, _ = tempColor:ToHSV()
				tempColor = Color3.fromHSV(h, s, percent)
			...
			local function updateOpacity(input)
				local delta = input.Position.X - opacityTrack.AbsolutePosition.X
				local percent = math.clamp(delta / opacityTrack.AbsoluteSize.X, 0, 1)
				opacityThumb.Position = UDim2.new(percent, 0, 0.5, 0)
				
				tempTransparency = 1 - percent
				isUpdatingInputs = true
				aInput.Text = tostring(math.floor(percent * 100))
				isUpdatingInputs = false
			...
			-- Unified global input listeners
			userInputService.InputChanged:Connect(function(input)
			...
			-- 5. Previews
			local previewsFrame = Instance.new("Frame")
			previewsFrame.Name = "PreviewsFrame"
			previewsFrame.Size = UDim2.new(1, 0, 0, 24)
			previewsFrame.BackgroundTransparency = 1
			previewsFrame.LayoutOrder = 5
			previewsFrame.Parent = panel

			local previewsLayout = Instance.new("UIListLayout")
			previewsLayout.FillDirection = Enum.FillDirection.Horizontal
			previewsLayout.SortOrder = Enum.SortOrder.LayoutOrder
			previewsLayout.Padding = UDim.new(0, 4)
			previewsLayout.Parent = previewsFrame

			local newColorBG = Instance.new("ImageLabel")
			newColorBG.Name = "NewColorBG"
			newColorBG.Size = UDim2.new(0.5, -2, 1, 0)
			newColorBG.BackgroundTransparency = 1
			newColorBG.Image = "rbxassetid://143370504"
			newColorBG.ScaleType = Enum.ScaleType.Tile
			newColorBG.TileSize = UDim2.fromOffset(8, 8)
			newColorBG.LayoutOrder = 1
			newColorBG.Parent = previewsFrame

			local newColorBGCorner = Instance.new("UICorner")
			newColorBGCorner.CornerRadius = UDim.new(0, 4)
			newColorBGCorner.Parent = newColorBG

			newColorBar = Instance.new("Frame")
			newColorBar.Name = "NewColor"
			newColorBar.Size = UDim2.fromScale(1, 1)
			newColorBar.BackgroundColor3 = tempColor
			newColorBar.BackgroundTransparency = tempTransparency
			newColorBar.Parent = newColorBG

			local newColorCorner = Instance.new("UICorner")
			newColorCorner.CornerRadius = UDim.new(0, 4)
			newColorCorner.Parent = newColorBar

			local newColorStroke = Instance.new("UIStroke")
			newColorStroke.Color = Color3.fromRGB(255, 255, 255)
			newColorStroke.Transparency = 0.8
			newColorStroke.Parent = newColorBar

			local originalColorBG = Instance.new("ImageLabel")
			originalColorBG.Name = "OriginalColorBG"
			originalColorBG.Size = UDim2.new(0.5, -2, 1, 0)
			originalColorBG.BackgroundTransparency = 1
			originalColorBG.Image = "rbxassetid://143370504"
			originalColorBG.ScaleType = Enum.ScaleType.Tile
			originalColorBG.TileSize = UDim2.fromOffset(8, 8)
			originalColorBG.LayoutOrder = 2
			originalColorBG.Parent = previewsFrame

			local originalColorBGCorner = Instance.new("UICorner")
			originalColorBGCorner.CornerRadius = UDim.new(0, 4)
			originalColorBGCorner.Parent = originalColorBG

			originalColorBar = Instance.new("Frame")
			originalColorBar.Name = "OriginalColor"
			originalColorBar.Size = UDim2.fromScale(1, 1)
			originalColorBar.BackgroundColor3 = originalColor
			originalColorBar.BackgroundTransparency = originalTransparency
			originalColorBar.Parent = originalColorBG

			local originalColorCorner = Instance.new("UICorner")
			originalColorCorner.CornerRadius = UDim.new(0, 4)
			originalColorCorner.Parent = originalColorBar

			local originalColorStroke = Instance.new("UIStroke")
			originalColorStroke.Color = Color3.fromRGB(255, 255, 255)
			originalColorStroke.Transparency = 0.8
			originalColorStroke.Parent = originalColorBar

			-- 6. Actions Frame (Confirm / Cancel Buttons)
			local actionsFrame = Instance.new("Frame")
			actionsFrame.Name = "ActionsFrame"
			actionsFrame.Size = UDim2.new(1, 0, 0, 60)
			actionsFrame.BackgroundTransparency = 1
			actionsFrame.LayoutOrder = 6
			...
			confirmBtn.BackgroundColor3 = Color3.fromRGB(0, 122, 255)
			confirmBtn.Text = "Confirm"
			confirmBtn.TextColor3 = Color3.fromRGB(255, 255, 255)
			confirmBtn.TextSize = 13
			confirmBtn.FontFace = Font.new("rbxassetid://12187365364")
			confirmBtn.LayoutOrder = 1
			confirmBtn.Parent = actionsFrame
			...
			cancelBtn.FontFace = Font.new("rbxassetid://12187365364")
			cancelBtn.LayoutOrder = 2
			cancelBtn.Parent = actionsFrame
			...
			confirmBtn.MouseButton1Click:Connect(function()
				object.Value = tempColor
				object.Transparency = tempTransparency
				closePopover()
			end)
			...
			-- Set initial values positions
			updateSelectorDotFromColor(tempColor)

			-- 7. Position & Parent to ScreenGui (최종 렌더링)
			local camera = workspace.CurrentCamera
			local viewportSize = camera and camera.ViewportSize or Vector2.new(800, 600)
			local buttonAbsPos = structures.ColorButton.AbsolutePosition
			local buttonAbsSize = structures.ColorButton.AbsoluteSize

			local popoverWidth = 280
			local popoverHeight = 340

			local posX = buttonAbsPos.X - popoverWidth - 10
			local posY = buttonAbsPos.Y

			if posX < 10 then
				posX = buttonAbsPos.X + buttonAbsSize.X + 10
			end
			posX = math.clamp(posX, 10, viewportSize.X - popoverWidth - 10)
			posY = math.clamp(posY, 10, viewportSize.Y - popoverHeight - 10)

			local parentPosition = screenGui.AbsolutePosition
			panel.Position = UDim2.fromOffset(posX - parentPosition.X, posY - parentPosition.Y)
			
			-- 💥 여기서 메타테이블의 간섭 없이 순수 Roblox 인스턴스로 부모 관계를 맺습니다!
			...
			task.defer(function()
				...
				conn = userInputService.InputBegan:Connect(function(input)
					...
					if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
						...
						local insidePopover = pointInside(panel, mouse.X, adjustedY) or pointInside(panel, mouse.X, mouse.Y)
	...
	bindings.Value(properties.Value)
	bindings.Transparency(properties.Transparency)
	binder.Apply(properties, object)
...
local function getRaw(obj)
	if typeof(obj) == "table" then
		return obj.__instance or obj
	end
	return obj
end

return function(self, properties: PieChartProperties__DARKLUA_TYPE_ag): PieChart__DARKLUA_TYPE_ah	--// Imports
...
local creator = __DIST.d()
	...
	properties = properties or {}
	properties.Size = properties.Size or 140
	properties.Donut = properties.Donut == true
	properties.Data = properties.Data or {}

	-- Layout Orders for Horizontal Split
	local align = properties.Align or "Right"
	local hasTitle = properties.Title ~= nil
	local mainContainer
	local chartOrder = (align == "Right") and 3 or 1
	local textOrder = (align == "Right") and 1 or 3
	local dividerOrder = 2
	local innerChartOrder = (align == "Right") and 2 or 1
	local innerLegendOrder = (align == "Right") and 1 or 2

	if hasTitle then
		mainContainer = create("Frame")({
			Name = "ChartSplitLayout",
			Size = UDim2.new(1, 0, 0, properties.Size),
			BackgroundTransparency = 1,
			BorderSizePixel = 0,
			Parent = getRaw(parent),
		})
		structures.Body = mainContainer
		...
		create("Frame")({
			...
			properties.Subtitle and create("TextLabel")({
				Name = "Subtitle",
		...
		-- Create horizontal list layout in mainContainer (spacing reduced to 12)
		create("UIListLayout")({
			FillDirection = Enum.FillDirection.Horizontal,
			VerticalAlignment = Enum.VerticalAlignment.Center,
			Padding = UDim.new(0, 12),
		...
		local textBlock = mainContainer:FindFirstChild("TextBlock")
		if textBlock then
			structures.Title = textBlock:FindFirstChild("Title") :: TextLabel?
			structures.Subtitle = textBlock:FindFirstChild("Subtitle") :: TextLabel?
		end

		parent = mainContainer
	end

	-- Main horizontal layout containing chart and legends (spacing reduced to 16)
	local container = createHStack(self, {
		Padding = UDim.new(0, 16),
		HorizontalAlignment = Enum.HorizontalAlignment.Left,
		VerticalAlignment = Enum.VerticalAlignment.Center,
	})
	...
	if hasTitle then
		container.Structures.Body.LayoutOrder = chartOrder
		container.Structures.Body.Parent = getRaw(parent)
	else
		structures.Body = container.Structures.Body
		structures.Body.Parent = getRaw(parent)
	end

	-- 1. Chart Area Container
	local chartSize = math.clamp(properties.Size or 110, 80, 120)
	local chartFrame = create("CanvasGroup")({
		Name = "ChartArea",
		Size = UDim2.fromOffset(chartSize, chartSize),
		BackgroundTransparency = 1,
		BorderSizePixel = 0,
		LayoutOrder = innerChartOrder,
		Parent = getRaw(container.Structures.Body),
	})
	structures.ChartArea = chartFrame

	-- 2. Draw Wedges
	local function drawWedge(containerFrame, startAngle, sweepAngle, color)
		if sweepAngle <= 0 then
			return
		end

		local wedgeContainer = create("Frame")({
			Name = "WedgeContainer",
			...
			BackgroundTransparency = 1,
			Rotation = startAngle,
			Parent = getRaw(containerFrame),
		})

		local function createHalfWedge(parentFrame, rotationAngle)
			local half = create("CanvasGroup")({
				Name = "Half",
				Size = UDim2.fromScale(0.5, 1),
				Position = UDim2.fromScale(0.5, 0),
				BackgroundTransparency = 1,
				BorderSizePixel = 0,
				Parent = getRaw(parentFrame),
			})
			...
			create("Frame")({
				...
				BackgroundTransparency = 0,
				BorderSizePixel = 0,
				Rotation = 0, -- keep Circle non-rotated to avoid CanvasGroup clipping & UICorner bugs
				Parent = getRaw(half),
				...
				create("UIGradient")({
					Rotation = rotationAngle, -- rotate the gradient cut line instead
					Transparency = NumberSequence.new({
						NumberSequenceKeypoint.new(0, 0),
		...
		if sweepAngle <= 180 then
			createHalfWedge(wedgeContainer, sweepAngle)
		else
			-- Draw first half (180 deg)
			createHalfWedge(wedgeContainer, 180)

			-- Draw second half (sweepAngle - 180 deg) rotated by 180
			local secondWedgeContainer = create("Frame")({
				Name = "SecondWedgeContainer",
				Size = UDim2.fromScale(1, 1),
				BackgroundTransparency = 1,
				Rotation = 180,
				Parent = getRaw(wedgeContainer),
			})
			createHalfWedge(secondWedgeContainer, sweepAngle - 180)
		end
	end

	-- 3. Right Legend VStack (Static container)
	local legendStack = createVStack(self, {
		Padding = UDim.new(0, 8),
		HorizontalAlignment = Enum.HorizontalAlignment.Left,
		VerticalAlignment = Enum.VerticalAlignment.Center,
	})
	legendStack.Structures.Body.LayoutOrder = innerLegendOrder
	legendStack.Structures.Body.Parent = getRaw(container.Structures.Body)

	local currentValues = {}
	local activeLerpTask = nil

	local function renderChartWithValues(currentData)
		getRaw(chartFrame):ClearAllChildren()
		
		-- Preserve UIListLayout and UIPadding by only destroying GuiObjects
		local legendBody = getRaw(legendStack.Structures.Body)
		for _, child in ipairs(legendBody:GetChildren()) do
			if child:IsA("GuiObject") then
				child:Destroy()
			end
		end
		...
		for _, item in ipairs(currentData) do
			totalSum = totalSum + (item.Value or 0)
		end

		-- Draw segments
		if totalSum <= 0 then
			-- Draw single grey placeholder circle
			create("Frame")({
				Name = "EmptyCircle",
				Size = UDim2.new(1, -2, 1, -2),
				Position = UDim2.fromScale(0.5, 0.5),
			...
			for _, item in ipairs(currentData) do
				...
				if val > 0 then
					...
					drawWedge(chartFrame, currentAngle, sweep, item.Color or Color3.fromRGB(255, 255, 255))
					currentAngle = currentAngle + sweep
				end
			end
		end

		-- If Donut is active, add hollow center mask
		if properties.Donut then
			local donutCenter = create("Frame")({
				Name = "DonutCenter",
			...
			structures.DonutCenter = donutCenter
		end

		-- Render legend rows
		for _, item in ipairs(currentData) do
			local val = item.Value or 0
			local pct = totalSum > 0 and (val / totalSum) * 100 or 0
			local labelText = item.Label or "Category"
			...
			create("Frame")({
				...
				create("Frame")({
					...
					BackgroundColor3 = item.Color or Color3.fromRGB(255, 255, 255),
					BorderSizePixel = 0,
					LayoutOrder = 1,
				...
				create("TextLabel")({
					...
					BackgroundTransparency = 1,
					Text = string.format("%.0f (%.1f%%)", val, pct),
					TextSize = 12,
	...
	local function animateToData(targetData)
		if activeLerpTask then
			task.cancel(activeLerpTask)
			activeLerpTask = nil
		end

		local isAnimated = properties.Animated ~= false and properties.LiveAnimation ~= false
		if not isAnimated or #currentValues == 0 or #currentValues ~= #targetData then
			currentValues = {}
			for i, item in ipairs(targetData) do
				currentValues[i] = item.Value or 0
			end
			renderChartWithValues(targetData)
			return
		end

		local startValues = table.clone(currentValues)
		local startTime = os.clock()
		local duration = 0.35

		activeLerpTask = task.spawn(function()
			while true do
				local elapsed = os.clock() - startTime
				local alpha = math.clamp(elapsed / duration, 0, 1)
				local t = tweenService:GetValue(alpha, Enum.EasingStyle.Quart, Enum.EasingDirection.Out)

				local interpolatedData = {}
				for i, item in ipairs(targetData) do
					local sVal = startValues[i] or 0
					local tVal = item.Value or 0
					local curVal = sVal + (tVal - sVal) * t
					currentValues[i] = curVal

					local newItem = table.clone(item)
					newItem.Value = curVal
					table.insert(interpolatedData, newItem)
				end

				renderChartWithValues(interpolatedData)
	...
	animateToData(properties.Data or {})

	local bindings = {
		Data = function(value)
			properties.Data = value or {}
			animateToData(properties.Data)
		end,
		Donut = function(value: boolean)
			properties.Donut = (value == true)
			animateToData(properties.Data or {})
		end,
		Animated = function(value: boolean)
			properties.Animated = value
		end,
		LiveAnimation = function(value: boolean)
			properties.LiveAnimation = value
		end,
		Title = function(value: string?)
			properties.Title = value
			if structures.Title then
				structures.Title.Text = value or ""
			end
		end,
		Subtitle = function(value: string?)
			properties.Subtitle = value
			if structures.Subtitle then
				structures.Subtitle.Text = value or ""
			end
		end,
	}
...
return function(self, properties: LineChartProperties__DARKLUA_TYPE_ai): LineChart__DARKLUA_TYPE_aj	--// Imports
...
local creator = __DIST.d()
	...
	--// Setup default properties
	properties = properties or {}
	properties.Height = properties.Height or 150
	properties.Data = properties.Data or {}
	properties.Labels = properties.Labels or nil
	local chartColor = properties.Color

	-- Layout Orders for Vertical Stack
	local hasTitle = properties.Title ~= nil
	local mainContainer
	...
	if hasTitle then
		...
		-- Create divider line (horizontal)
		create("Frame")({
			Name = "Divider",
			Size = UDim2.new(1, 0, 0, 1),
			BorderSizePixel = 0,
	...
	local chartContainer = create("Frame")({
		...
		BackgroundTransparency = 1,
		BorderSizePixel = 0,
		LayoutOrder = hasTitle and 1 or nil,
		Parent = getRaw(parent),
	})
	
	if not hasTitle then
		structures.Body = chartContainer
	end

	-- Left Y-axis labels container (reserved width: 35px) - pushed down by 2px
	local yAxisContainer = create("Frame")({
		Name = "YAxis",
		Size = UDim2.new(0, 35, 1, -2),
		Position = UDim2.new(0, 0, 0, 2),
		BackgroundTransparency = 1,
		BorderSizePixel = 0,
		Parent = getRaw(chartContainer),
	})
	structures.YAxis = yAxisContainer

	-- Sub-container for visual rendering (shifted to the right by 35px) - pushed down by 2px
	local renderArea = create("CanvasGroup")({
		Name = "RenderArea",
	...
	structures.RenderArea = renderArea

	-- Tooltip reference (reusable)
	local activeTooltip = nil

	-- Main rendering function
	local function drawChart()
		local width = renderArea.AbsoluteSize.X
		local height = renderArea.AbsoluteSize.Y
		if width <= 0 or height <= 0 then
			renderArea.GroupTransparency = 0
			return
		end

		-- Clear old visual assets
		renderArea:ClearAllChildren()
		yAxisContainer:ClearAllChildren()

		local isAnimated = properties.Animated ~= false and properties.LiveAnimation ~= false
		if isAnimated then
			renderArea.GroupTransparency = 1
			tweenService:Create(getRaw(renderArea), TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
				GroupTransparency = 0,
			}):Play()
		else
			renderArea.GroupTransparency = 0
		...
		-- Reserve bottom height if labels are provided
		local plotHeight = height
		if properties.Labels then
			plotHeight = height - 24
		end
		...
		local resolvedColor = chartColor or self.Theme.Controls.Selection[1].Value

		-- 1. Draw horizontal reference grid lines and Y-axis labels (0%, 50%, 100%)
		local gridPercentages = { 0, 0.5, 1 }
		for _, pct in ipairs(gridPercentages) do
			local gridY = 10 + pct * (plotHeight - 20)
			
			-- Reference Grid Line
			create("Frame")({
				Name = "GridLine",
				Size = UDim2.new(1, 0, 0, 1),
				Position = UDim2.fromOffset(0, gridY),
				BorderSizePixel = 0,
				Parent = getRaw(renderArea),

				__dynamicKeys = {
					BackgroundColor3 = self.Theme.Text.Quaternary[1],
					BackgroundTransparency = self.Theme.Text.Quaternary[2],
				},
			})

			-- Y-axis Value Label
			local valAtPct = maxVal - pct * range
			local valStr = string.format("%.1f", valAtPct)
			if valAtPct % 1 == 0 then
				valStr = string.format("%d", valAtPct)
			end

			create("TextLabel")({
				Name = "YLabel_" .. pct,
				Size = UDim2.new(1, -8, 0, 14),
				Position = UDim2.fromOffset(0, gridY - 7),
				BackgroundTransparency = 1,
				Text = valStr,
				TextSize = 10,
				TextXAlignment = Enum.TextXAlignment.Right,
				FontFace = Font.new("rbxassetid://12187365364"),
				Parent = getRaw(yAxisContainer),
				__dynamicKeys = {
					TextColor3 = self.Theme.Text.Secondary[1],
					TextTransparency = self.Theme.Text.Secondary[2],
				},
		...
		-- 2. Calculate coordinate positions for all points
		local points = {}
		for i = 1, n do
			local val = data[i]
			...
			-- Calculate Y coordinate (scaled, with 10px margin top/bottom so dots aren't clipped)
			local y = 10 + (1 - (val - minVal) / range) * (plotHeight - 20)
		...
		-- 4. Draw interactive data dots (forces true round circles)
		for i = 1, n do
			local p = points[i]
			local val = data[i]

			local dot = create("ImageButton")({
				Name = "Dot_" .. i,
				Size = UDim2.fromOffset(8, 8),
				...
				create("UICorner")({
					CornerRadius = UDim.new(0.5, 0), -- Force round
				}),
			}) :: ImageButton

			-- Hover Events for tooltip and scaling
			dot.MouseEnter:Connect(function()
				tweenService:Create(getRaw(dot), TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
					Size = UDim2.fromOffset(12, 12),
				}):Play()

				-- Destroy active tooltip if exists
				if activeTooltip then
					activeTooltip:Destroy()
				end

				-- Create new floating tooltip above the dot
				activeTooltip = create("Frame")({
					Name = "Tooltip",
					Size = UDim2.fromOffset(60, 22),
					Position = UDim2.fromOffset(p.X, p.Y - 20),
					AnchorPoint = Vector2.new(0.5, 0.5),
					BackgroundColor3 = Color3.fromRGB(30, 30, 30),
					ZIndex = 100,
					Parent = getRaw(renderArea),
		...
		-- 5. Draw X-axis labels if provided
		if properties.Labels then
			for i = 1, math.min(n, #properties.Labels) do
				local p = points[i]
				local labelText = properties.Labels[i]

				create("TextLabel")({
					Name = "Label_" .. i,
					Size = UDim2.fromOffset(60, 16),
					Position = UDim2.fromOffset(p.X, height - 10),
					AnchorPoint = Vector2.new(0.5, 0.5),
					BackgroundTransparency = 1,
					Text = labelText,
					TextSize = 11,
	...
	-- Connect AbsoluteSize change to update chart rendering
	renderArea:GetPropertyChangedSignal("AbsoluteSize"):Connect(function()
		task.spawn(drawChart)
	end)
	...
	local bindings = {
		...
		Height = function(value: number)
			properties.Height = value
			chartContainer.Size = UDim2.new(1, 0, 0, value)
			task.spawn(drawChart)
		end,
		Title = function(value: string?)
			properties.Title = value
	...
	local object = binder.Wrap(properties, bindings, structures.Body or chartContainer)
...
return function(self, properties: BarChartProperties__DARKLUA_TYPE_ak): BarChart__DARKLUA_TYPE_al	--// Imports
...
local creator = __DIST.d()
	...
	-- Main rendering function
	local function drawChart()
		-- Clear old visual grid lines and Y axis
		for _, child in ipairs(getRaw(renderArea):GetChildren()) do
		...
		-- Check if labels exist in data items
		...
		-- Reserve bottom height if labels are present
		local plotHeight = height
		if hasLabels then
			plotHeight = height - 24
		end
		...
		-- 1. Draw horizontal reference grid lines and Y-axis labels (0%, 50%, 100% of plot height)
		local gridPercentages = { 0, 0.5, 1 }
		for _, pct in ipairs(gridPercentages) do
			local gridY = 10 + pct * (plotHeight - 20)
		...
		-- 2. Draw or reuse bars container
		local barsContainer = getRaw(renderArea):FindFirstChild("BarsContainer") :: Frame?
		if not barsContainer then
			barsContainer = create("Frame")({
				Name = "BarsContainer",
			...
			barsContainer.Size = UDim2.new(1, 0, 0, plotHeight)
		end

		-- Calculate dynamic bar width
		local padding = 16
		local availableWidth = width
		local barWidth = (availableWidth - (padding * (n + 1))) / n
		barWidth = math.clamp(barWidth, 8, 80) -- clamp to keep it looking nice

		local selectionColor = self.Theme.Controls.Selection[1].Value
		local isAnimated = properties.Animated ~= false and properties.LiveAnimation ~= false

		-- Remove excess columns if data size decreased
		for _, child in ipairs(barsContainer:GetChildren()) do
			if child:IsA("Frame") and child.Name:find("Column_") then
				local idxStr = child.Name:gsub("Column_", "")
		...
		-- 3. Render or update bars
		for i, item in ipairs(data) do
			local val = item.Value or 0
			local pctHeight = val / maxVal
			local barColor = item.Color or selectionColor
			local targetSize = UDim2.new(1, 0, pctHeight, 0)

			local colName = "Column_" .. i
			local column = barsContainer:FindFirstChild(colName) :: Frame?
			local bar: ImageButton? = nil

			if column then
				column.Size = UDim2.new(0, barWidth, 1, 0)
				bar = column:FindFirstChild("Bar") :: ImageButton?
				
				if bar then
					if isAnimated then
						tweenService:Create(getRaw(bar), TweenInfo.new(0.35, Enum.EasingStyle.Quart, Enum.EasingDirection.Out), {
							Size = targetSize,
				...
				column = create("Frame")({
					Name = colName,
					Size = UDim2.new(0, barWidth, 1, 0),
					BackgroundTransparency = 1,
					BorderSizePixel = 0,
					LayoutOrder = i,
					Parent = getRaw(barsContainer),
				})

				bar = create("ImageButton")({
					Name = "Bar",
					Size = isAnimated and UDim2.new(1, 0, 0, 0) or targetSize,
					Position = UDim2.fromScale(0.5, 1),
					AnchorPoint = Vector2.new(0.5, 1),
					BackgroundColor3 = barColor,
					BackgroundTransparency = 0,
					...
					create("UIGradient")({
						...
						Color = ColorSequence.new({
							...
							ColorSequenceKeypoint.new(1, barColor:Lerp(Color3.fromRGB(0, 0, 0), 0.15)),
						}),
					}),
				}) :: ImageButton
				...
				bar.MouseEnter:Connect(function()
					tweenService:Create(getRaw(bar), TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
						BackgroundTransparency = 0.15,
					}):Play()
					...
					-- Create tooltip above the bar
					activeTooltip = create("Frame")({
						Name = "Tooltip",
						Size = UDim2.fromOffset(60, 22),
						Position = UDim2.new(0.5, 0, 1 - pctHeight, -12),
						AnchorPoint = Vector2.new(0.5, 0.5),
						BackgroundColor3 = Color3.fromRGB(30, 30, 30),
						ZIndex = 100,
						Parent = getRaw(column),
						...
						create("TextLabel")({
							Size = UDim2.fromScale(1, 1),
							BackgroundTransparency = 1,
							Text = item.Label and (tostring(item.Label) .. ": " .. tostring(val)) or tostring(val),
							TextColor3 = Color3.fromRGB(240, 240, 240),
							TextSize = 11,
							FontFace = Font.new("rbxassetid://12187365364", Enum.FontWeight.SemiBold),
						}),
			...
			-- X-Axis Label
			local existingLabel = column:FindFirstChild("Label")
...
end function __DIST.V():typeof(__modImpl())local v=__DIST.cache.V if not v then v={c=__modImpl()}__DIST.cache.V=v end return v.c end end do local function __modImpl()--// Imports

local binder = __DIST.c()
local appRecorder = __DIST.f()
...
,
	...
	TextField = __DIST.o()
,
	KeybindField = __DIST.F(),
	Slider = __DIST.G(),
	Button = __DIST.p()
,
	Stepper = __DIST.H(),
	RadioButtonGroup = __DIST.I(),
	PopUpButton = __DIST.L(),
	PullDownButton = __DIST.M(),
	Page = __DIST.v()
,
	Notification = __DIST.P(),
	ImageSurface = __DIST.R(),
	ColorPicker = __DIST.S(),
	PieChart = __DIST.T(),
	LineChart = __DIST.U(),
	BarChart = __DIST.V(),
	ShortcutBadge = __DIST.q()
,
	Hotkey = __DIST.r()
,
}
...
-- 부모 Row 인스턴스 탐색 헬퍼
local function findParentRow(instance: Instance): Instance?
	local current = instance
	while current do
		if current.Name == "Row" then
			return current
		end
		current = current.Parent
	end
...
-- 이웃 Row의 LockOverlay 감지 함수 (Row 단위로 탐색)
local function getAdjacentLockedElements(targetInstance: Instance)
	...
	for _, child in ipairs(parent:GetChildren()) do
		if child.Name == "Row" and child.Visible then
	...
	table.sort(children, function(a, b)
		...
		return table.find(pChildren, a) < table.find(pChildren, b)
	end)

	local myIndex = table.find(children, targetInstance)
	if not myIndex then
		return nil, nil, false, false
	end

	local prevElem = children[myIndex - 1]
	local nextElem = children[myIndex + 1]

	local prevOverlay = prevElem and prevElem:FindFirstChild("LockOverlay")
	local nextOverlay = nextElem and nextElem:FindFirstChild("LockOverlay")

	local prevLocked = prevOverlay and prevOverlay:GetAttribute("IsLocked") == true
	local nextLocked = nextOverlay and nextOverlay:GetAttribute("IsLocked") == true

	return prevElem, nextElem, prevLocked, nextLocked
end

-- 연속된 잠금 Row 그룹들을 찾아서 통합 및 비주얼 업데이트 수행
local function updateLockGroups(startInstance: Instance)
	local parent = startInstance.Parent
	...
	for _, row in ipairs(children) do
		local overlay = row:FindFirstChild("LockOverlay", true)
		local isLocked = overlay ~= nil and overlay:GetAttribute("IsLocked") == true
		if isLocked then
			table.insert(currentGroup, row)
		else
			-- 잠금되지 않은 일반 Row의 원래 제목(LeftAccessory) 및 구분선 복원
			local leftAccessory = row:FindFirstChild("LeftAccessory")
			if leftAccessory then
				leftAccessory.Visible = true
			end
			local layoutIgnore = row:FindFirstChild("LayoutIgnore")
			local divider = layoutIgnore and layoutIgnore:FindFirstChild("Divider")
			if divider then
	...
	for _, group in ipairs(groups) do
		local size = #group
		local centerIndex = math.ceil(size / 2)

		-- 그룹 전체의 총합 높이 계산 (패딩 포함)
		local totalHeight = 0
		for _, r in ipairs(group) do
			totalHeight = totalHeight + r.AbsoluteSize.Y
		end

		-- 부모 컨테이너의 UIListLayout 패딩 오프셋 추출하여 높이에 합산
		local paddingOffset = 0
		local listLayout = parent:FindFirstChildOfClass("UIListLayout")
		if listLayout then
			if listLayout.Padding.Scale > 0 then
				paddingOffset = parent.AbsoluteSize.Y * listLayout.Padding.Scale
			else
				paddingOffset = listLayout.Padding.Offset
			end
		end
		totalHeight = totalHeight + (paddingOffset * (size - 1))

		for idx, row in ipairs(group) do
			local overlay = row:FindFirstChild("LockOverlay", true)
			if not overlay then continue end

			-- 이웃 잠금 상태
			local isFirst = (idx == 1)
			local isLast = (idx == size)

			-- 물리적인 팽창 원천 차단: 오버레이 자체의 Y 크기를 0으로 고정하여 AutomaticSize 영향 완벽 차단!
			...
			local divider = layoutIgnore and layoutIgnore:FindFirstChild("Divider")
			if divider then
				divider.Visible = (idx == size)
			end

			-- 원래 제목/소제목(LeftAccessory) 노출 제어 (2개 이상 병합 시 첫 번째만 보여주고 아래는 숨김)
			local leftAccessory = row:FindFirstChild("LeftAccessory")
			if leftAccessory then
				if size > 1 then
					leftAccessory.Visible = isFirst
				else
					leftAccessory.Visible = true
				end
			end

			-- 실제 비주얼 크기는 부모 Row의 AbsoluteSize.Y를 기준으로 설정
			local parentSize = row.AbsoluteSize
			local blurBg = overlay:FindFirstChild("BlurBackground") :: ImageLabel
			local blocker = overlay:FindFirstChild("Blocker") :: TextButton

			-- 2개 이상 결합 시 첫 번째 Row의 Blocker/BlurBg만 크게 키우고 나머지는 숨김! (단일 거대 잠금 창)
			if size > 1 then
				if isFirst then
					if blurBg then
						blurBg.Visible = true
						blurBg.Position = UDim2.new(0, -6, 0, 0)
						blurBg.Size = UDim2.new(1, 12, 0, totalHeight)
					end
					if blocker then
						blocker.Visible = true
						blocker.Position = UDim2.new(0, -6, 0, 0)
						blocker.Size = UDim2.new(1, 12, 0, totalHeight)
					end
				else
					if blurBg then blurBg.Visible = false end
				...
				if blurBg then
					blurBg.Visible = true
					blurBg.Position = UDim2.new(0, -6, 0, 0)
					blurBg.Size = UDim2.new(1, 12, 0, parentSize.Y)
				end
				if blocker then
					blocker.Visible = true
					blocker.Position = UDim2.new(0, -6, 0, 0)
					blocker.Size = UDim2.new(1, 12, 0, parentSize.Y)
				end
			end

			local lockIcon = overlay:FindFirstChild("LockIcon") :: ImageLabel
			local lockTitle = overlay:FindFirstChild("LockTitle") :: TextLabel
			local lockSubtitle = overlay:FindFirstChild("LockSubtitle") :: TextLabel

			local titleText = overlay:GetAttribute("LockTitle") or "Locked"
			local subtitleText = overlay:GetAttribute("LockSubtitle") or ""

			if lockTitle then lockTitle.Text = titleText end
			if lockSubtitle then lockSubtitle.Text = subtitleText end

			-- 레이아웃 정렬 최적화 (2개 이상 병합 시 자물쇠는 전체 합산 창 정중앙 배치, 제목 소제목은 전체 합산 창 좌측 상단 배치)
			if size > 1 then
				if isFirst then
					-- 자물쇠 아이콘 전체 정중앙 배치
					if lockIcon then
						lockIcon.Visible = true
						lockIcon.Position = UDim2.new(0.5, 0, 0, totalHeight / 2) -- 전체 락 창의 정중앙 Y축
						tweenService:Create(lockIcon, tweenInfo, { ImageTransparency = 0.0 }):Play()
					end

					-- 전체 높이에 비례한 수학적 폰트 크기 계산 (물리적 팽창 없음)
					local calcTitleSize = math.clamp(math.round(totalHeight * 0.06), 12, 22)
					local calcSubSize = math.clamp(math.round(totalHeight * 0.045), 9, 15)

					-- 큼직한 커스텀 제목 좌측 상단 배치 (고정 좌표 기준, Size.Y = 0)
					if lockTitle then
						lockTitle.Visible = true
						lockTitle.AnchorPoint = Vector2.new(0, 0)
						lockTitle.Position = UDim2.new(0, 14, 0, 14)
						lockTitle.Size = UDim2.new(0.6, 0, 0, 0)
						lockTitle.TextSize = calcTitleSize
						lockTitle.TextXAlignment = Enum.TextXAlignment.Left
						tweenService:Create(lockTitle, tweenInfo, { TextTransparency = 0.0, TextStrokeTransparency = 0.8 }):Play()
					end

					-- 큼직한 커스텀 소제목 제목 하단 배치 (타이틀 폰트 크기에 따라 비례 밀어내기)
					if lockSubtitle then
						local hasSub = (subtitleText ~= "")
						lockSubtitle.Visible = hasSub
						if hasSub then
							lockSubtitle.AnchorPoint = Vector2.new(0, 0)
							lockSubtitle.Position = UDim2.new(0, 14, 0, 14 + calcTitleSize + 4)
							lockSubtitle.Size = UDim2.new(0.6, 0, 0, 0)
							lockSubtitle.TextSize = calcSubSize
							lockSubtitle.TextXAlignment = Enum.TextXAlignment.Left
							tweenService:Create(lockSubtitle, tweenInfo, { TextTransparency = 0.0, TextStrokeTransparency = 0.8 }):Play()
						else
							lockSubtitle.TextTransparency = 1
							lockSubtitle.TextStrokeTransparency = 1
						end
					end
				else
					-- 첫 번째가 아닌 나머지 Row들의 자물쇠/텍스트는 전부 숨김
					if lockIcon then lockIcon.Visible = false end
					if lockTitle then lockTitle.Visible = false end
					if lockSubtitle then lockSubtitle.Visible = false end
				end
			else
				-- 1개 단독 잠금일 때 (중앙 자물쇠 하단에 제목/소제목 세로 정렬 배치)
				if lockIcon then
					lockIcon.Visible = true
					lockIcon.Position = UDim2.new(0.5, 0, 0, parentSize.Y * 0.28)
					tweenService:Create(lockIcon, tweenInfo, { ImageTransparency = 0.0 }):Play()
				end
				
				local hasSub = (subtitleText ~= "")
				local calcTitleSize = math.clamp(math.round(parentSize.Y * 0.22), 12, 22)
				local calcSubSize = math.clamp(math.round(parentSize.Y * 0.15), 9, 14)

				if lockTitle then
					lockTitle.Visible = true
					lockTitle.AnchorPoint = Vector2.new(0.5, 0.5)
					lockTitle.Position = UDim2.new(0.5, 0, hasSub and 0.55 or 0.65, 0)
					lockTitle.Size = UDim2.new(0.8, 0, 0, 0)
					lockTitle.TextSize = calcTitleSize
				...
				if lockSubtitle then
					lockSubtitle.Visible = hasSub
					if hasSub then
						lockSubtitle.AnchorPoint = Vector2.new(0.5, 0.5)
						lockSubtitle.Position = UDim2.new(0.5, 0, 0.76, 0)
						lockSubtitle.Size = UDim2.new(0.8, 0, 0, 0)
						lockSubtitle.TextSize = calcSubSize
...
-- 잠금 오버레이 생성기
local function createLockOverlay(parentInstance: Instance)
	local overlay = Instance.new("Frame")
	overlay.Name = "LockOverlay"
	
	-- Y 크기를 0으로 주어 AutomaticSize 무한 팽창 버그를 원천 봉쇄합니다!
	overlay.Size = UDim2.new(1, 0, 0, 0)
	overlay.Position = UDim2.fromScale(0, 0)
	...
	overlay.ZIndex = 100
	overlay.Active = true
	overlay.ClipsDescendants = false -- 자식(Blocker 및 BlurBg)이 Row 전체를 덮어 그리도록 설정
	overlay:SetAttribute("IsLocked", true)

	local parentCorner = parentInstance:FindFirstChildOfClass("UICorner")
	...
	-- 터치 및 클릭 이벤트를 차단하고, 반투명 검은색 배경 역할을 수행할 Blocker Button
	local blocker = Instance.new("TextButton")
	blocker.Name = "Blocker"
	blocker.Position = UDim2.new(0, -6, 0, 0)
	blocker.Size = UDim2.new(1, 12, 0, parentInstance.AbsoluteSize.Y)
	blocker.BackgroundColor3 = Color3.fromRGB(15, 15, 15) -- 검은색 아크릴 필터
	blocker.BackgroundTransparency = 1 -- 트윈으로 제어 예정 (목표치 0.15)
	...
	blurBg.Position = UDim2.new(0, -6, 0, 0)
	blurBg.Size = UDim2.new(1, 12, 0, parentInstance.AbsoluteSize.Y)
	blurBg.BackgroundTransparency = 1
	blurBg.Image = "rbxassetid://15629910543"
	blurBg.ImageColor3 = Color3.fromRGB(255, 255, 255) -- 하얀색 블러 이미지 복구
	blurBg.ImageTransparency = 1
	blurBg.ZIndex = 99
	
	if parentCorner then
		local corner = Instance.new("UICorner")
		corner.CornerRadius = parentCorner.CornerRadius
		corner.Parent = blurBg
	end
	blurBg.Parent = overlay

	local lockIcon = Instance.new("ImageLabel")
	lockIcon.Name = "LockIcon"
	lockIcon.AnchorPoint = Vector2.new(0.5, 0.5)
	lockIcon.Position = UDim2.new(0.5, 0, 0, parentInstance.AbsoluteSize.Y * 0.32)
	lockIcon.Size = UDim2.fromOffset(16, 16)
	lockIcon.BackgroundTransparency = 1
	lockIcon.Image = "rbxassetid://6031082533"
	lockIcon.ImageColor3 = Color3.fromRGB(255, 255, 255) -- 하얀색 자물쇠
	...
	lockTitle.AnchorPoint = Vector2.new(0.5, 0.5)
	lockTitle.Position = UDim2.new(0.5, 0, 0, parentInstance.AbsoluteSize.Y * 0.58)
	lockTitle.Size = UDim2.new(1, 0, 0, 0) -- 팽창 버그 완전 방지: Y크기 영역을 0으로 강제!
	...
	lockTitle.Font = Enum.Font.SourceSansBold
	lockTitle.TextScaled = false -- 팽창 방지를 위해 false 지정
	lockTitle.TextTransparency = 1
	lockTitle.ZIndex = 101
	lockTitle.TextStrokeColor3 = Color3.fromRGB(0, 0, 0)
	lockTitle.TextStrokeTransparency = 1
	...
	lockSubtitle.AnchorPoint = Vector2.new(0.5, 0.5)
	lockSubtitle.Position = UDim2.new(0.5, 0, 0, parentInstance.AbsoluteSize.Y * 0.78)
	lockSubtitle.Size = UDim2.new(1, 0, 0, 0) -- Y크기 영역 0으로 고정
	lockSubtitle.BackgroundTransparency = 1
	lockSubtitle.Text = ""
	lockSubtitle.TextColor3 = Color3.fromRGB(180, 180, 180)
	lockSubtitle.TextSize = 14
	lockSubtitle.Font = Enum.Font.SourceSans
	lockSubtitle.TextScaled = false
	lockSubtitle.TextTransparency = 1
	lockSubtitle.ZIndex = 101
	lockSubtitle.TextStrokeColor3 = Color3.fromRGB(0, 0, 0)
	lockSubtitle.TextStrokeTransparency = 1
	lockSubtitle.Parent = overlay

	-- 부모 크기가 바뀌면 실시간으로 그룹 병합 비주얼을 갱신
	local conn
	local function syncSize()
		if overlay and overlay.Parent then
			updateLockGroups(parentInstance)
		end
	end
	conn = parentInstance:GetPropertyChangedSignal("AbsoluteSize"):Connect(syncSize)
	...
	-- Row 내의 LayoutIgnore 폴더에 오버레이를 배치하여 팽창 원천 제거
	local layoutIgnore = parentInstance:FindFirstChild("LayoutIgnore")
	local targetParent = layoutIgnore or parentInstance
...
local function wrap(name, make)
	return function(self, ...)
		...
		if typeof(result) == "table" then
			...
			if self and typeof(self) == "table" then
				if self.Type == "Window" then
					result.__window = self
				elseif self.__window then
					result.__window = self.__window
				end
			end
		end
		...
		if typeof(result) == "table" and final ~= nil then
			result.Lock = function(elementSelf, isLocked: boolean, title: string?, subtitle: string?)
				-- 부모 Row가 있으면 Row 전체를 잠금 대상으로 지정
				local targetInstance = findParentRow(final) or final
				local overlay = targetInstance:FindFirstChild("LockOverlay", true)

				if isLocked then
					if not overlay then
						overlay = createLockOverlay(targetInstance)
					end
					overlay:SetAttribute("IsLocked", true)
					overlay:SetAttribute("LockTitle", title or "Locked")
					overlay:SetAttribute("LockSubtitle", subtitle or "")
					overlay.Visible = true

					local blurBg = overlay:FindFirstChild("BlurBackground") :: ImageLabel
					local blocker = overlay:FindFirstChild("Blocker") :: TextButton

					-- 잠금 상태 전파 및 병합 비주얼 갱신
					updateLockGroups(targetInstance)

					-- 페이드인 애니메이션 (개별 Row 어두운 아크릴 + 화이트 블러 가우시안 텍스처 합성)
					if blocker then
						tweenService:Create(blocker, tweenInfo, { BackgroundTransparency = 0.15 }):Play()
					end
					if blurBg then
						tweenService:Create(blurBg, tweenInfo, { ImageTransparency = 0.2 }):Play() -- 흰색 안개 블러를 80% 밀도로 얹음
					end
				else
					if overlay then
						overlay:SetAttribute("IsLocked", false)
						local blocker = overlay:FindFirstChild("Blocker") :: TextButton
						local blurBg = overlay:FindFirstChild("BlurBackground") :: ImageLabel
						local lockIcon = overlay:FindFirstChild("LockIcon") :: ImageLabel
						local lockTitle = overlay:FindFirstChild("LockTitle") :: TextLabel
						...
						local t1 = blocker and tweenService:Create(blocker, tweenInfo, { BackgroundTransparency = 1 })
						local t2 = blurBg and tweenService:Create(blurBg, tweenInfo, { ImageTransparency = 1 })
						local t3 = lockIcon and tweenService:Create(lockIcon, tweenInfo, { ImageTransparency = 1 })
						local t4 = lockTitle and tweenService:Create(lockTitle, tweenInfo, { TextTransparency = 1, TextStrokeTransparency = 1 })
						local t5 = lockSubtitle and tweenService:Create(lockSubtitle, tweenInfo, { TextTransparency = 1, TextStrokeTransparency = 1 })
						...
						-- 락이 해제되었으므로 이웃 락 오버레이들의 비주얼 즉시 재조정
						updateLockGroups(targetInstance)

						task.delay(0.3, function()
							local currentOverlay = targetInstance:FindFirstChild("LockOverlay", true)
							if currentOverlay == overlay and overlay:GetAttribute("IsLocked") == false then
								overlay:Destroy()
								-- 삭제 완료 후 최종 갱신
								updateLockGroups(targetInstance)
							end
...
return components
end function __DIST.W():typeof(__modImpl())local v=__DIST.cache.W if not v then v={c=__modImpl()}__DIST.cache.W=v end return v.c end end do local function __modImpl()--// Imports
local creator = __DIST.d()
...
return {
	...
	Controls = {
		...
		WindowControlDisabled = color4("FFFFFF", 20),
		...
		ImageSurface = {
			Gradient = value(ColorSequence.new({
				ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 255, 255)),
...
return {
	...
	Controls = {
		...
		WindowControlDisabled = color4("000000", 20),
		WindowControlIcon = color4("000000", 50),
...
end function __DIST.Y():typeof(__modImpl())local v=__DIST.cache.Y if not v then v={c=__modImpl()}__DIST.cache.Y=v end return v.c end end do local function __modImpl()return {
	Dark = __DIST.X(),
	Light = __DIST.Y(),
}
end function __DIST.Z():typeof(__modImpl())local v=__DIST.cache.Z if not v then v={c=__modImpl()}__DIST.cache.Z=v end return v.c end end do local function __modImpl()--// Private Methods
...
}end function __DIST._():typeof(__modImpl())local v=__DIST.cache._ if not v then v={c=__modImpl()}__DIST.cache._=v end return v.c end end end--// Imports
local utility = __DIST.a()
local types = __DIST.b()
local creator = __DIST.d()
local binder = __DIST.c()
...
local symbols = __DIST.g()
local components = __DIST.W()

local themes = __DIST.Z()
local accents = __DIST._()
...
--// Initialize
cascade.New = function(properties: AppProperties__DARKLUA_TYPE_q): App__DARKLUA_TYPE_r	if not game:IsLoaded() then
		game.Loaded:Wait()
	end
...
cascade.Component = function(properties: ComponentProperties__DARKLUA_TYPE_s?): ComponentContext__DARKLUA_TYPE_t	properties = properties or {}
...
cascade.AppDump = function(app: App__DARKLUA_TYPE_r, options: { [string]: any }?)
