...
--[[
    ...
    @buildDate "2026-06-19T20:46:04.732125800+00:00"
    @buildCfg "Task"
    @buildVers "0.0.0"
...
return function(self, properties: any)
	...
	local function openPopover()
		...
		local ok, err = xpcall(function()
			...
			-- 1. Left Visual Spec
			local visualSpec = create("ImageLabel")({
				Name = "VisualSpec",
			...
			-- 3. Middle Split (Contains VisualSpec & InputsFrame)
			...
			-- 5. Transparency Slider Thumb & Track
			...
			local track = create("ImageButton")({
				Name = "Track",
			...
			-- 6. Previews
			local newColorBar = create("Frame")({
				Name = "NewColor",
			...
			local originalColorBar = create("Frame")({
				Name = "OriginalColor",
				Size = UDim2.new(0.5, -2, 1, 0),
