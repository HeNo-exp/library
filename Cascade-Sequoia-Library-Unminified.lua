...
--[[
    ...
    @buildDate "2026-06-20T01:18:22.648358400+00:00"
    @buildCfg "Task"
    @buildVers "0.0.0"
...
return function(self, properties: any)
	...
	local function openPopover()
		...
		local ok, err = xpcall(function()
			...
			colorWheel.Image = "rbxassetid://4155801252" -- Premium HSV color wheel
			...
			local selectorDot = Instance.new("Frame")
			...
			local hexInput = createPureInputField("Hex", colorToHex(tempColor), 1, inputsFrame)
			local rInput = createPureInputField("Red", math.floor(tempColor.R * 255), 2, inputsFrame)
			local gInput = createPureInputField("Green", math.floor(tempColor.G * 255), 3, inputsFrame)
			local bInput = createPureInputField("Blue", math.floor(tempColor.B * 255), 4, inputsFrame)
			local aInput = createPureInputField("Alpha", math.floor((1 - tempTransparency) * 100), 5, inputsFrame)
			...
			local brightnessThumb = Instance.new("Frame")
			...
			local opacityThumb = Instance.new("Frame")
			...
			local newColorBar = Instance.new("Frame")
			...
			local originalColorBar = Instance.new("Frame")
