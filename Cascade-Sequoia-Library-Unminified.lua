...
--[[
    ...
    @buildDate "2026-06-20T15:31:10.641010Z"
    @buildCfg "Task"
    @buildVers "0.0.0"
...
type App__DARKLUA_TYPE_r = AppProperties__DARKLUA_TYPE_q & Components__DARKLUA_TYPE_al
...
type ComponentContext__DARKLUA_TYPE_t = ComponentProperties__DARKLUA_TYPE_s & Components__DARKLUA_TYPE_al
...
type Window__DARKLUA_TYPE_y = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & WindowProperties__DARKLUA_TYPE_x
...
type Section__DARKLUA_TYPE_A = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & SectionProperties__DARKLUA_TYPE_z
...
type Tab__DARKLUA_TYPE_C = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & TabProperties__DARKLUA_TYPE_B & {
...
type Form__DARKLUA_TYPE_E = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & FormProperties__DARKLUA_TYPE_D

type RowProperties__DARKLUA_TYPE_F = Frame__DARKLUA_TYPE_g & {
	SearchIndex: string?,
}

type Row__DARKLUA_TYPE_G = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & RowProperties__DARKLUA_TYPE_F & {
...
type Stack__DARKLUA_TYPE_I = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & StackProperties__DARKLUA_TYPE_H
...
type TitleStack__DARKLUA_TYPE_K = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & TitleStackProperties__DARKLUA_TYPE_J
...
type PageSection__DARKLUA_TYPE_M = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & PageSectionProperties__DARKLUA_TYPE_L

type PageProperties__DARKLUA_TYPE_N = ScrollingFrame

type Page__DARKLUA_TYPE_O = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & PageProperties__DARKLUA_TYPE_N

type LabelProperties__DARKLUA_TYPE_P = TextLabel__DARKLUA_TYPE_h

type Label__DARKLUA_TYPE_Q = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & LabelProperties__DARKLUA_TYPE_P

type SymbolProperties__DARKLUA_TYPE_R = ImageLabel__DARKLUA_TYPE_j & {
	Style: ("Primary" | "Secondary")?,
}

type Symbol__DARKLUA_TYPE_S = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & SymbolProperties__DARKLUA_TYPE_R
...
type Toggle__DARKLUA_TYPE_U = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & ToggleProperties__DARKLUA_TYPE_T
...
type TextField__DARKLUA_TYPE_W = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & TextFieldProperties__DARKLUA_TYPE_V
...
type KeybindField__DARKLUA_TYPE_Y = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & KeybindFieldProperties__DARKLUA_TYPE_X
...
type Slider__DARKLUA_TYPE__ = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & SliderProperties__DARKLUA_TYPE_Z
...
type Button__DARKLUA_TYPE_1 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & ButtonProperties__DARKLUA_TYPE_0
...
type Stepper__DARKLUA_TYPE_3 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & StepperProperties__DARKLUA_TYPE_2 & {
	Increment: () -> nil,
	Decrement: () -> nil,
}
...
type RadioButtonGroup__DARKLUA_TYPE_5 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & RadioButtonGroupProperties__DARKLUA_TYPE_4 & {
...
type PopUpButton__DARKLUA_TYPE_9 = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & PopUpButtonProperties__DARKLUA_TYPE_8 & {
	Option: (Name: string?) -> Frame__DARKLUA_TYPE_g,
...
type PullDownButton__DARKLUA_TYPE_ab = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & PullDownButtonProperties__DARKLUA_TYPE_aa & {
	Option: (Name: string?) -> Frame__DARKLUA_TYPE_g,
	Remove: (Index: number?) -> nil,
}
...
type Notification__DARKLUA_TYPE_ad = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & NotificationProperties__DARKLUA_TYPE_ac & {
...
type ImageSurface__DARKLUA_TYPE_af = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & ImageSurfaceProperties__DARKLUA_TYPE_ae

type PieSliceData__DARKLUA_TYPE_ag = {
	Value: number,
	Label: string?,
	Color: Color3?,
}

type PieChartProperties__DARKLUA_TYPE_ah = Frame__DARKLUA_TYPE_g & {
	Size: UDim2?,
	InnerRadiusRatio: number?,
	SegmentStyle: ("Segmented" | "Solid")?,
	Data: { [number]: PieSliceData__DARKLUA_TYPE_ag }?,
}

type PieChart__DARKLUA_TYPE_ai = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & PieChartProperties__DARKLUA_TYPE_ah

type LineChartProperties__DARKLUA_TYPE_aj = Frame__DARKLUA_TYPE_g & {
	Height: number?,
	Data: { [number]: number }?,
	Labels: { [number]: string }?,
}

type LineChart__DARKLUA_TYPE_ak = BaseComponent__DARKLUA_TYPE_p & Components__DARKLUA_TYPE_al & LineChartProperties__DARKLUA_TYPE_aj

type Components__DARKLUA_TYPE_al = {
...
--// Types
type DropdownMenuStructureConfig__DARKLUA_TYPE_am = {
	Name: string?,
}

--// Types
type DropdownMenuConfig__DARKLUA_TYPE_an = {
	Name: string?,
	Anchor: any?,
	AnchorMode: string?,
	Gap: number?,
...
return function(self, config: DropdownMenuStructureConfig__DARKLUA_TYPE_am?)
	--// Variables
	local create = creator.Create
...
--// Public Methods
function DropdownMenu.new(context, componentStructures, config: DropdownMenuConfig__DARKLUA_TYPE_an?)
	config = config or {}
...
local creator = __DIST.d()
	...
	local function getThemeColor(theme, path, defaultColor)
		local current = theme
		for _, key in ipairs(path) do
			if not current or type(current) ~= "table" then
				return creator.Value(defaultColor)
			end
			current = current[key]
		end
	...
	local function getThemeTransparency(theme, path, defaultTrans)
		local current = theme
		for _, key in ipairs(path) do
			if not current or type(current) ~= "table" then
				return creator.Value(defaultTrans)
			end
			current = current[key]
		end
		if type(current) == "table" and current[2] then
			return current[2]
		end
		return creator.Value(defaultTrans)
	end
	...
	properties = properties or {}
	properties.Size = properties.Size or UDim2.fromOffset(130, 130)
	properties.InnerRadiusRatio = properties.InnerRadiusRatio or 0.7
	properties.SegmentStyle = properties.SegmentStyle or "Segmented"
	properties.Data = properties.Data or {
		{ Value = 100, Label = "No Data", Color = Color3.fromRGB(100, 100, 100) }
	}
	properties.Width = properties.Width or (properties.Size.X.Offset + 180)

	-- Default color palette if not provided
	local defaultPalette = {
		Color3.fromRGB(0, 120, 255),  -- Accent Blue
		Color3.fromRGB(0, 200, 100),  -- Emerald Green
		Color3.fromRGB(255, 120, 0),  -- Orange
		Color3.fromRGB(160, 80, 255), -- Purple
		Color3.fromRGB(255, 60, 140), -- Magenta
		Color3.fromRGB(0, 180, 180),  -- Teal
	}

	-- Calculate total value
	local totalValue = 0
	for _, slice in ipairs(properties.Data) do
	...
	-- Create Main Wrapper Row/Frame
	structures.Body = create("Frame")({
		Name = "PieChartWrapper",
		BackgroundTransparency = 1,
		Size = UDim2.new(0, properties.Width, 0, math.max(130, properties.Size.Y.Offset)),
		Parent = parent,
	...
	local legendContainer = create("Frame")({
		...
		BackgroundTransparency = 1,
		Size = UDim2.new(1, -properties.Size.X.Offset - 20, 1, 0),
		LayoutOrder = 2,
		Parent = structures.Body.__instance,
	...
	local N = 90 -- Using 90 segments for high-fidelity circular sweep with half the instances
	local segments = {}

	-- Pre-calculate initial sizing for segments to prevent CanvasGroup caching a blank state
	local initSizeX = properties.Size.X.Offset > 0 and properties.Size.X.Offset or 130
	local initSizeY = properties.Size.Y.Offset > 0 and properties.Size.Y.Offset or 130
	local initRadius = math.min(initSizeX, initSizeY) / 2
	local initArcLength = (2 * math.pi * initRadius) / N
	local initWidth = properties.SegmentStyle == "Solid" and (initArcLength + 1.2) or math.max(1.5, initArcLength * 0.6)

	for i = 1, N do
		local percentPos = (i - 0.5) / N
		local targetColor = Color3.fromRGB(120, 120, 120)

		-- Find which slice this segment belongs to
		local cumulativePercent = 0
		for idx, slice in ipairs(properties.Data) do
			local slicePercent = slice.Value / totalValue
			if percentPos >= cumulativePercent and percentPos <= (cumulativePercent + slicePercent) then
				targetColor = slice.Color or defaultPalette[((idx - 1) % #defaultPalette) + 1]
				break
			end
		...
		local segment = create("Frame")({
			...
			Size = UDim2.fromOffset(initWidth, initRadius + 2),
			AnchorPoint = Vector2.new(0.5, 1),
			Position = UDim2.fromScale(0.5, 0.5),
			Rotation = (i - 1) * (360 / N),
			Parent = chartFrame,
	...
	local function updateSizing()
		...
		local sizeX = absSize.X > 0 and absSize.X or properties.Size.X.Offset
		local sizeY = absSize.Y > 0 and absSize.Y or properties.Size.Y.Offset

		-- Fallback to default if both are 0
		if sizeX <= 0 then sizeX = 130 end
		...
		-- Toggle rotation slightly to force Roblox CanvasGroup rendering cache update
		chartFrame.Rotation = 0.01 + (chartFrame.Rotation == 0.01 and 0.001 or 0)
	end

	chartFrame:GetPropertyChangedSignal("AbsoluteSize"):Connect(updateSizing)
	structures.Body.AncestryChanged:Connect(function()
		if structures.Body:IsDescendantOf(game) then
			task.defer(updateSizing)
		end
	end)
	task.defer(updateSizing)
	...
	-- Build Legends
	for idx, slice in ipairs(properties.Data) do
		local targetColor = slice.Color or defaultPalette[((idx - 1) % #defaultPalette) + 1]
		local percentage = math.floor((slice.Value / totalValue) * 100 + 0.5)
		local sliceLabel = slice.Label or "Slice " .. idx
		...
		create("Frame")({
			...
			create("TextLabel")({
				...
				Text = string.format("%s (%d%%)", sliceLabel, percentage),
				...
				__dynamicKeys = {
					TextColor3 = getThemeColor(self.Theme, {"Text", "Primary"}, Color3.fromRGB(255, 255, 255)),
					TextTransparency = getThemeTransparency(self.Theme, {"Text", "Primary"}, 0),
				},
			}),
		})
	end
...
local creator = __DIST.d()
	...
	--// Setup default properties
	properties = properties or {}
	properties.Height = properties.Height or 120
	properties.Data = properties.Data or { 0 }
	properties.Labels = properties.Labels or {}

	local isRightAccessory = (typeof(parent) == "Instance" and parent.Name == "RightAccessory")
	properties.Width = properties.Width or (isRightAccessory and 350 or nil)

	-- Find Min/Max value bounds
	local valMin = math.huge
	local valMax = -math.huge
	for _, val in ipairs(properties.Data) do
		if val < valMin then valMin = val end
		if val > valMax then valMax = val end
	end
	if valMin == math.huge then
		valMin, valMax = 0, 1
	elseif valMin == valMax then
		valMin = valMin - 1
		valMax = valMax + 1
	end
	...
	structures.Body = create("Frame")({
		Name = "LineChart",
		BackgroundTransparency = 1,
		Size = properties.Width and UDim2.new(0, properties.Width, 0, properties.Height) or UDim2.new(1, 0, 0, properties.Height),
		Parent = parent,
	}) :: Frame

	-- Create Plot Area Canvas
	local plotArea = create("Frame")({
		Name = "PlotArea",
		BackgroundTransparency = 1,
		Size = UDim2.fromScale(1, 1),
		Parent = structures.Body.__instance,
	...
	-- Create 3 horizontal grid lines (0%, 50%, 100%)
	for i = 0, 2 do
		create("Frame")({
			Name = "Grid_" .. (i * 50),
			BorderSizePixel = 0,
			...
			Position = UDim2.new(0, 20, 15/properties.Height + (i / 2) * (1 - 40/properties.Height), 0),
			Parent = plotArea,
		})
	end
	...
	local lineFrames = {}
	local xAxisLabels = {}
	local nPoints = #properties.Data

	-- Instanciate Chart Vector Lines
	for i = 1, nPoints - 1 do
		local line = create("Frame")({
			...
			__dynamicKeys = {
				BackgroundColor3 = getThemeColor(self.Theme, {"Controls", "Selection"}, Color3.fromRGB(0, 120, 255)),
			},
		}) :: Frame
		table.insert(lineFrames, line)
	end

	-- Instanciate Chart Node Dots
	for i = 1, nPoints do
		...
		table.insert(nodeDots, dot)
	end

	-- Instanciate X-Axis Labels
	for i = 1, nPoints do
		local textLabel = properties.Labels[i]
		if textLabel then
			local label = create("TextLabel")({
				...
				__dynamicKeys = {
					TextColor3 = getThemeColor(self.Theme, {"Text", "Secondary"}, Color3.fromRGB(150, 150, 150)),
					TextTransparency = getThemeTransparency(self.Theme, {"Text", "Secondary"}, 0.45),
				},
			}) :: TextLabel
			table.insert(xAxisLabels, label)
		end
	end

	-- Sizing & Plotting update logic
	local points = {}

	local function updatePlot()
		local absSize = plotArea.AbsoluteSize
		local sizeX = absSize.X > 0 and absSize.X or (properties.Width or 350)
		local sizeY = absSize.Y > 0 and absSize.Y or properties.Height

		local paddingX = 20
		local paddingYTop = 15
		local paddingYBottom = 25

		local plotW = sizeX - (paddingX * 2)
		local plotH = sizeY - paddingYTop - paddingYBottom

		-- 1. Calculate Plot positions
		for i, val in ipairs(properties.Data) do
			local pctX = (nPoints > 1) and ((i - 1) / (nPoints - 1)) or 0.5
			local posX = paddingX + pctX * plotW

			local pctY = (range > 0) and ((val - valMin) / range) or 0.5
			local posY = paddingYTop + (1 - pctY) * plotH

			points[i] = Vector2.new(posX, posY)
		end

		-- 2. Update Dots
		for i, pt in ipairs(points) do
			local dot = nodeDots[i]
			if dot then
				dot.Position = UDim2.fromOffset(pt.X, pt.Y)
			end
		end

		-- 3. Update Line Segments
		for i = 1, nPoints - 1 do
		...
		-- 4. Update Labels
		for i, label in ipairs(xAxisLabels) do
			local pt = points[i]
			if pt and label then
				label.Position = UDim2.fromOffset(pt.X, sizeY - 12)
			end
		end
	end

	-- Connect resize event
	plotArea:GetPropertyChangedSignal("AbsoluteSize"):Connect(updatePlot)
	structures.Body.AncestryChanged:Connect(function()
		if structures.Body:IsDescendantOf(game) then
			task.defer(updatePlot)
		end
	end)
	task.defer(updatePlot)

	-- Node Hover Tooltips setup
	for i, dot in ipairs(nodeDots) do
		dot.MouseEnter:Connect(function()
			tooltipLabel.Text = tostring(properties.Data[i])
			tooltip.Position = UDim2.fromOffset(points[i].X - 30, points[i].Y - 30)
...
end function __DIST.S():typeof(__modImpl())local v=__DIST.cache.S if not v then v={c=__modImpl()}__DIST.cache.S=v end return v.c end end do local function __modImpl()--// Imports
...
end function __DIST.V():typeof(__modImpl())local v=__DIST.cache.V if not v then v={c=__modImpl()}__DIST.cache.V=v end return v.c end end do local function __modImpl()return {
	Dark = __DIST.U(),
	Light = __DIST.V(),
}
end function __DIST.W():typeof(__modImpl())local v=__DIST.cache.W if not v then v={c=__modImpl()}__DIST.cache.W=v end return v.c end end do local function __modImpl()--// Private Methods
...
}end function __DIST.X():typeof(__modImpl())local v=__DIST.cache.X if not v then v={c=__modImpl()}__DIST.cache.X=v end return v.c end end end--// Imports
local utility = __DIST.a()
local types = __DIST.b()
local creator = __DIST.d()
local binder = __DIST.c()
...
local symbols = __DIST.g()
local components = __DIST.T()

local themes = __DIST.W()
local accents = __DIST.X()
