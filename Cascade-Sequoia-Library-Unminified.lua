...
--[[
    ...
    @buildDate "2026-07-23T07:44:15.508745Z"
    @buildCfg "Task"
    @buildVers "0.0.0"
...
local function updateLockGroups(startInstance: Instance)
	...
	for _, group in ipairs(groups) do
		...
		for idx, row in ipairs(group) do
			...
			if blurBg then
				blurBg.Position = UDim2.fromScale(0, 0)
				blurBg.Size = UDim2.new(1, 0, 0, parentSize.Y)
			end
			if blocker then
				blocker.Position = UDim2.fromScale(0, 0)
				blocker.Size = UDim2.new(1, 0, 0, parentSize.Y)
			end
...
local function createLockOverlay(parentInstance: Instance)
	...
	blocker.Position = UDim2.fromScale(0, 0)
	blocker.Size = UDim2.new(1, 0, 0, parentInstance.AbsoluteSize.Y)
	...
	blurBg.Position = UDim2.fromScale(0, 0)
	blurBg.Size = UDim2.new(1, 0, 0, parentInstance.AbsoluteSize.Y)
