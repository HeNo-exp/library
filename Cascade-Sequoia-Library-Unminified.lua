...
--[[
    ...
    @buildDate "2026-07-21T16:08:31.576479Z"
    @buildCfg "Task"
    @buildVers "0.0.0"
...
local creator = __DIST.d()
	...
	local function drawChart()
		...
		if isAnimated then
			chartFrame.GroupTransparency = 1
			tweenService:Create(getRaw(chartFrame), TweenInfo.new(0.25, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {
				GroupTransparency = 0,
			}):Play()
		else
			chartFrame.GroupTransparency = 0
		end
