...
--[[
    ...
    @buildDate "2026-06-20T17:51:18.169311Z"
    @buildCfg "Release"
    @buildVers "1.2.0"
...
local creator = __DIST.d()
	...
	-- Left Y-axis labels container (reserved width: 35px) - pushed down by 4px
	...
	-- Sub-container for visual rendering (shifted to the right by 35px) - pushed down by 4px
	local renderArea = create("Frame")({
		Name = "RenderArea",
		Size = UDim2.new(1, -35, 1, -4),
