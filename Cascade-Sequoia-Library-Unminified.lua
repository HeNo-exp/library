...
--[[
    ...
    @buildDate "2026-07-21T16:05:35.442140Z"
    @buildCfg "Task"
    @buildVers "0.0.0"
...
local creator = __DIST.d()
	...
	local chartSize = math.min(properties.Size or 110, 110)
	local chartFrame = create("CanvasGroup")({
		...
		create("UIAspectRatioConstraint")({
			AspectRatio = 1,
			AspectType = Enum.AspectType.FitInParent,
		}),
	})
				...
				bar.MouseEnter:Connect(function()
					...
					activeTooltip = create("Frame")({
						...
						create("TextLabel")({
							Size = UDim2.fromScale(1, 1),
							BackgroundTransparency = 1,
							Text = item.Label and string.format("%s: %v", item.Label, val) or tostring(val),
							TextColor3 = Color3.fromRGB(240, 240, 240),
							TextSize = 11,
							FontFace = Font.new("rbxassetid://12187365364", Enum.FontWeight.SemiBold),
						}),
